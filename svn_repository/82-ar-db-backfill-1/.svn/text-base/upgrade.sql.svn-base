...
VAR_START_DATE date := to_date('01-Jan-2001', 'DD-Mon-YYYY');
VAR_END_DATE date := to_date('01-Apr-2013', 'DD-Mon-YYYY');
begin
  ...
  LOOP
    ...
    IF (REC.capture_date is not NULL) THEN
      INSERT INTO AR_BALANCE_APPLIES (CHARGE_ID,INVOICE_ID,AMOUNT,CREATE_DATE,CREATED_BY) VALUES (REC.CHARGE_ID,REC.INVOICE_ID,REC.CHARGE_AMOUNT,COALESCE(REC.capture_date,REC.create_date),VAR_JIRA);
    END IF;
