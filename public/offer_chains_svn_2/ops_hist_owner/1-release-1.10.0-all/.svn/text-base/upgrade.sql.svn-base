...
CREATE OR REPLACE PACKAGE "PUBLIC_PROCS_OPS_V15" AS 
...
END PUBLIC_PROCS_OPS_V15;
.
/

CREATE OR REPLACE PACKAGE BODY "PUBLIC_PROCS_OPS_V15" AS
...
BEGIN
  PROCS_HISTORY_V15.CREATE_NOTIFICATION_HISTORY(
    in_notification_id,
    in_account_id,
    in_group_id,
    notification_reason_type_id,
...
BEGIN
  PROCS_HISTORY_V15.CREATE_NOTIF_FAILURE_HISTORY(
    in_error_message,
    in_notification_id,
    in_create_date
  );
...
GRANT EXECUTE ON PUBLIC_PROCS_OPS_V15 TO ops_owner;
GRANT EXECUTE ON PUBLIC_PROCS_OPS_V15 TO ops_aaa_app;
GRANT EXECUTE ON PUBLIC_PROCS_OPS_V15 TO ops_payment_app;
GRANT EXECUTE ON PUBLIC_PROCS_OPS_V15 TO ops_notif_app;
