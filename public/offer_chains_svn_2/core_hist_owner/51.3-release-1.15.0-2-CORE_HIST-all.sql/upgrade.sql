...
EXCEPTION
WHEN OTHERS THEN
  RAISE_APPLICATION_ERROR(CORE_OWNER.APP_EXCEPTION_CODES_V21.UNKNOWN_ERROR,
...
CREATE OR REPLACE PACKAGE "PUBLIC_PROCS_CORE_V21" AS 
...
END PUBLIC_PROCS_CORE_V21;
.
/

CREATE OR REPLACE PACKAGE BODY "PUBLIC_PROCS_CORE_V21" AS
...
BEGIN
  PROCS_HISTORY_V21.CREATE_ITUNES_RECEIPT_HISTORY (
    in_id => in_id,
...
BEGIN
  PROCS_HISTORY_V21.CREATE_NOTIFICATION_HISTORY(
    in_notification_id,
    in_account_id,
    in_group_id,
    notification_reason_type_id,
...
BEGIN
  PROCS_HISTORY_V21.CREATE_NOTIF_FAILURE_HISTORY(
    in_error_message,
    in_notification_id,
    in_create_date
);
...
CREATE OR REPLACE PACKAGE "PROCS_PARTITIONS_V21" AS 
...
END PROCS_PARTITIONS_V21;
.
/

CREATE OR REPLACE PACKAGE BODY "PROCS_PARTITIONS_V21" AS
...
grant execute on PUBLIC_PROCS_CORE_V21 to core_owner;
grant execute on PUBLIC_PROCS_CORE_V21 to core_app;
grant execute on PUBLIC_PROCS_CORE_V21 to ops_notif_app;
