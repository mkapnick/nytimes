...
EXCEPTION
WHEN OTHERS THEN
  RAISE_APPLICATION_ERROR(CORE_OWNER.APP_EXCEPTION_CODES_V18.UNKNOWN_ERROR,
...
CREATE OR REPLACE PACKAGE "PUBLIC_PROCS_CORE_V18" AS 
...
END PUBLIC_PROCS_CORE_V18;
.
/

CREATE OR REPLACE PACKAGE BODY "PUBLIC_PROCS_CORE_V18" AS
...
BEGIN
  PROCS_HISTORY_V18.CREATE_ITUNES_RECEIPT_HISTORY (
    in_id => in_id,
...
BEGIN
  PROCS_HISTORY_V18.CREATE_NOTIFICATION_HISTORY(
    in_notification_id,
    in_account_id,
    in_group_id,
    notification_reason_type_id,
...
BEGIN
  PROCS_HISTORY_V18.CREATE_NOTIF_FAILURE_HISTORY(
    in_error_message,
    in_notification_id,
    in_create_date
);
...
CREATE OR REPLACE PACKAGE "PROCS_PARTITIONS_V18" AS 
...
END PROCS_PARTITIONS_V18;
.
/

CREATE OR REPLACE PACKAGE BODY "PROCS_PARTITIONS_V18" AS
...
grant execute on PUBLIC_PROCS_CORE_V18 to core_owner;
grant execute on PUBLIC_PROCS_CORE_V18 to core_app;
GRANT EXECUTE ON PUBLIC_PROCS_CORE_V18 TO ops_owner;
GRANT EXECUTE ON PUBLIC_PROCS_CORE_V18 TO ops_aaa_app;
GRANT EXECUTE ON PUBLIC_PROCS_CORE_V18 TO ops_payment_app;
GRANT EXECUTE ON PUBLIC_PROCS_CORE_V18 TO ops_notif_app;