...
CREATE OR REPLACE PACKAGE "PUBLIC_PROCS_CORE_V15" AS 
...
END PUBLIC_PROCS_CORE_V15;
.
/

CREATE OR REPLACE PACKAGE BODY "PUBLIC_PROCS_CORE_V15" AS
...
BEGIN
  PROCS_HISTORY_V15.CREATE_ITUNES_RECEIPT_HISTORY (
    in_id => in_id,
...
CREATE OR REPLACE PACKAGE "PROCS_PARTITIONS_V15" AS 
...
END PROCS_PARTITIONS_V15;
.
/

CREATE OR REPLACE PACKAGE BODY "PROCS_PARTITIONS_V15" AS
...
grant execute on PUBLIC_PROCS_CORE_V15 to core_owner;
grant execute on PUBLIC_PROCS_CORE_V15 to core_app;
