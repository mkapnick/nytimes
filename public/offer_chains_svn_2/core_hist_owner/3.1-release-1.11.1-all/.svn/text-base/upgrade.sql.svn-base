...
CREATE OR REPLACE PACKAGE "PUBLIC_PROCS_CORE_V17" AS 
...
END PUBLIC_PROCS_CORE_V17;
.
/

CREATE OR REPLACE PACKAGE BODY "PUBLIC_PROCS_CORE_V17" AS
...
BEGIN
  PROCS_HISTORY_V17.CREATE_ITUNES_RECEIPT_HISTORY (
    in_id => in_id,
...
grant execute on PUBLIC_PROCS_CORE_V17 to core_owner;
grant execute on PUBLIC_PROCS_CORE_V17 to core_app;
GRANT EXECUTE ON PUBLIC_PROCS_CORE_V17 TO ops_owner;
GRANT EXECUTE ON PUBLIC_PROCS_CORE_V17 TO ops_aaa_app;
GRANT EXECUTE ON PUBLIC_PROCS_CORE_V17 TO ops_payment_app;
GRANT EXECUTE ON PUBLIC_PROCS_CORE_V17 TO ops_notif_app;