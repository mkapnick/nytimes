...
CREATE OR REPLACE PACKAGE "NOTIFICATION_STATUSES_V16" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_COMMON_V16" AS 
...
END PROCS_COMMON_V16;
.
/

CREATE OR REPLACE PACKAGE BODY "PROCS_COMMON_V16" AS
...
CREATE OR REPLACE PACKAGE "PROCS_NOTIFICATION_V16" AS 

PROCEDURE GET_NOTIFICATION_TYPE_BY_NAME (
/*
Throws exceptions:
CORE_OWNER.APP_EXCEPTION_CODES_V16.NOT_FOUND
CORE_OWNER.APP_EXCEPTION_CODES_V16.UNKNOWN_ERROR
*/
...
END PROCS_NOTIFICATION_V16;
.
/

CREATE OR REPLACE PACKAGE BODY "PROCS_NOTIFICATION_V16" AS
...
WHEN NO_DATA_FOUND THEN
  PROCS_COMMON_V16.THROW_EXCEPTION(CORE_OWNER.APP_EXCEPTION_CODES_V16.NOT_FOUND,
    SPROC_NAME, 'No such type');
WHEN OTHERS THEN
  PROCS_COMMON_V16.THROW_EXCEPTION(CORE_OWNER.APP_EXCEPTION_CODES_V16.UNKNOWN_ERROR,
...
BEGIN
  ...
  INSERT INTO NOTIFICATION (
    ...
    NOTIFICATION_STATUSES_V16.NOTIFICATION_PENDING,
  ...
  --BEGIN
  --  OPS_HIST_OWNER.PUBLIC_PROCS_OPS_V16.CREATE_NOTIFICATION_HISTORY (
  ...
  --    notification_status_id      => NOTIFICATION_STATUSES_V16.NOTIFICATION_PENDING,
...
WHEN CAN_NOT_CREATE_HISTORY THEN
  PROCS_COMMON_V16.THROW_EXCEPTION(CORE_OWNER.APP_EXCEPTION_CODES_V16.INTERNAL_ERROR,
...
(
  ...
  WHERE
    ...
    AND (
      NOTIFICATION.NOTIFICATION_STATUS_ID = NOTIFICATION_STATUSES_V16.NOTIFICATION_PENDING
      OR NOTIFICATION.NOTIFICATION_STATUS_ID = NOTIFICATION_STATUSES_V16.NOTIFICATION_FAILED
    )
    AND (
...
BEGIN
  ...
  IF in_notification_status_id != NOTIFICATION_STATUSES_V16.NOTIFICATION_SENT
    AND in_notification_status_id != NOTIFICATION_STATUSES_V16.NOTIFICATION_PENDING
    AND in_notification_status_id != NOTIFICATION_STATUSES_V16.NOTIFICATION_FAILED THEN
  ...
  IF (in_notification_status_id = NOTIFICATION_STATUSES_V16.NOTIFICATION_SENT OR num_fails >= max_fails) then
    FOR REC IN (
        ...
        BEGIN
          OPS_HIST_OWNER.PUBLIC_PROCS_OPS_V16.CREATE_NOTIF_FAILURE_HISTORY(
...
CREATE OR REPLACE PACKAGE "PROCS_PROCESS_RETRY_V16" AS
...
END PROCS_PROCESS_RETRY_V16;
.
/

CREATE OR REPLACE PACKAGE BODY "PROCS_PROCESS_RETRY_V16" AS
...
SPROC_NAME CONSTANT VARCHAR2(32) := 'PROCS_PROCESS_RETRY_V16';
BEGIN
...
EXCEPTION
WHEN OTHERS THEN
  RAISE_APPLICATION_ERROR(CORE_OWNER.APP_EXCEPTION_CODES_V16.UNKNOWN_ERROR,
    'Unknown error');
...
CREATE OR REPLACE PACKAGE "PUBLIC_PROCS_CLIENT_V16" AS 
...
END PUBLIC_PROCS_CLIENT_V16;
.
/

CREATE OR REPLACE PACKAGE BODY "PUBLIC_PROCS_CLIENT_V16" AS
...
BEGIN
  PROCS_NOTIFICATION_V16.GET_NOTIFICATION_TYPE_BY_NAME (
...
BEGIN
  PROCS_NOTIFICATION_V16.ADD_NOTIFICATION (
    in_sender_account_id,
    in_recipient_group_id,
    in_notification_type_id,
    in_date_to_notify,
...
grant execute on OPS_OWNER.NOTIFICATION_STATUSES_V16 to ops_aaa_app;
grant execute on OPS_OWNER.PROCS_NOTIFICATION_V16 to ops_aaa_app;
grant execute on OPS_OWNER.PROCS_SYSTEM_V16 to ops_aaa_app;

grant execute on OPS_OWNER.NOTIFICATION_STATUSES_V16 to ops_payment_app;
grant execute on OPS_OWNER.PROCS_NOTIFICATION_V16 to ops_payment_app;
grant execute on OPS_OWNER.PROCS_SYSTEM_V16 to ops_payment_app;

grant execute on OPS_OWNER.NOTIFICATION_STATUSES_V16 to ops_notif_app;
grant execute on OPS_OWNER.PROCS_NOTIFICATION_V16 to ops_notif_app;
grant execute on OPS_OWNER.PROCS_SYSTEM_V16 to ops_notif_app;

grant execute on OPS_OWNER.PUBLIC_PROCS_CLIENT_V16 to core_licensing_app;
grant execute on OPS_OWNER.PUBLIC_PROCS_CLIENT_V16 to core_billing_app;
grant execute on OPS_OWNER.PUBLIC_PROCS_CLIENT_V16 to core_app;
grant execute on OPS_OWNER.PUBLIC_PROCS_CLIENT_V16 to cupy_app;

grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to core_owner;
grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to core_app;
grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to cupy_app;
grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to core_billing_app;
grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to core_licensing_app;
grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to ops_notif_app;
grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to etl_app;
grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to core_subup_app;
grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to core_poller_app;
grant execute on OPS_OWNER.PROCS_PROCESS_RETRY_V16 to core_subup_app;
