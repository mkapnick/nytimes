...
CREATE OR REPLACE PACKAGE "PROCS_ACCOUNT_CRU_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_ACCOUNT_V15" AS 

PROCEDURE ANNOTATE_ACCOUNT (
/*
Throws exceptions:
APP_EXCEPTION_CODES_V15.NOT_FOUND
APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR
*/
...
/*
Throws exceptions:
APP_EXCEPTION_CODES_V15.INTERNAL_ERROR,
APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
*/
  in_group_id   IN NUMBER,
...
IN:
instr_status:
1 - get active instruments only (default)
0 - get inactive instruments only
...
*/
  in_group_id       IN NUMBER,
  out_result_cc_set OUT SYS_REFCURSOR,
  out_default_id    OUT NUMBER,
  in_instr_status   IN NUMBER DEFAULT GLOBAL_STATUSES_V15.CREDIT_CARD_ACTIVE
);
...
IN:
instr_status:
GLOBAL_CONSTANTS_V15.TRUE - get active instruments only (default)
GLOBAL_CONSTANTS_V15.FALSE - get inactive instruments only
...
*/
  ...
  in_instr_status   IN NUMBER DEFAULT GLOBAL_CONSTANTS_V15.TRUE
);
...
*/
  in_group_id       IN NUMBER,
  out_result_pp_set OUT SYS_REFCURSOR,
  out_default_id    OUT NUMBER,
  in_instr_status   IN NUMBER DEFAULT GLOBAL_STATUSES_V15.PAYPAL_ACTIVE
);
...
APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR
Return:
  GLOBAL_CONSTANTS_V15.TRUE if ACCOUNT.EXEMPT_ID is not null
  GLOBAL_CONSTANTS_V15.FALSE else
*/
  in_group_id       IN NUMBER,
...
APP_EXCEPTION_CODES_V15.NOT_FOUND,
APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
APP_EXCEPTION_CODES_V15.INVALID_PARAMETER
...
CREATE OR REPLACE PACKAGE "PROCS_ADDRESS_CRU_V15" AS 
...
END PROCS_ADDRESS_CRU_V15;
.
/

CREATE OR REPLACE PACKAGE "PROCS_ADDRESS_V15" AS
...
CREATE OR REPLACE PACKAGE "PROCS_ADJUSTMENTS_V15" AS 
...
END PROCS_ADJUSTMENTS_V15;
.
/

CREATE OR REPLACE PACKAGE "PROCS_ADX_V15" AS
...
CREATE OR REPLACE PACKAGE "PROCS_AMAZON_CRU_V15" AS
...
END PROCS_AMAZON_CRU_V15;
.
/

CREATE OR REPLACE PACKAGE "PROCS_AMAZON_V15" AS
...
CREATE OR REPLACE PACKAGE "PROCS_CHARGE_CRU_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_CHARGE_V15" AS 
...
CREATE OR REPLACE
PACKAGE PROCS_ENTITLEMENT_V15 AS
...
CREATE OR REPLACE PACKAGE "PROCS_FIN_INSTRUMENTS_CRU_V15" AS 
...
END PROCS_FIN_INSTRUMENTS_CRU_V15;
.
/
...
CREATE OR REPLACE PACKAGE "PROCS_FIN_INSTRUMENTS_V15" AS
...
PROCEDURE GET_UNREDEEMED_GCS (
  ...
  in_process_name         IN OPS_OWNER.PROCESS_RETRY_THROTTLE.PROCESS_NAME%TYPE
);
...
CREATE OR REPLACE PACKAGE "PROCS_GROUP_ACCOUNT_CRU_V15" AS
...
END PROCS_GROUP_ACCOUNT_CRU_V15;
.
/
...
CREATE OR REPLACE PACKAGE "PROCS_GROUP_ACCOUNT_V15" As
...
CREATE OR REPLACE PACKAGE "PROCS_HISTORY_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_INVOICE_CRU_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_INVOICE_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_ITUNES_RECEIPT_CRU_V15" AS
...
END PROCS_ITUNES_RECEIPT_CRU_V15;
.
/
...
CREATE OR REPLACE PACKAGE "PROCS_ITUNES_RECEIPT_V15" AS
...
CREATE OR REPLACE PACKAGE "PROCS_LICENSE_CRU_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_LICENSE_V15" AS 
...
*/
    ...
    in_updated_by     IN VARCHAR2,
    in_ent_end        IN NUMBER DEFAULT GLOBAL_CONSTANTS_V15.FALSE
);
...
CREATE OR REPLACE PACKAGE "PROCS_LINE_ITEMS_CRU_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_LINE_ITEMS_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_LOCKING_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_OFFER_CHAIN_V15" AS
...
APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR
Returns:
GLOBAL_CONSTANTS_V15.TRUE if there are at least one same product
GLOBAL_CONSTANTS_V15.FALSE else
*/
  in_offer_chain_1         IN OFFER_CHAIN.ID%TYPE,
  in_offer_chain_2         IN OFFER_CHAIN.ID%TYPE,
  in_use_eligibility_rules IN NUMBER DEFAULT GLOBAL_CONSTANTS_V15.FALSE
) RETURN NUMBER;
...
APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR
Returns:
GLOBAL_CONSTANTS_V15.TRUE cancelation key is 1 (in OFFER_CHAIN_META_DATA)
GLOBAL_CONSTANTS_V15.FALSE else
*/
  in_offer_chain_id IN NUMBER
) RETURN NUMBER;
...
CREATE OR REPLACE PACKAGE "PROCS_PRODUCT_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_RECONCILIATION_CRU_V15" AS 
...
END PROCS_RECONCILIATION_CRU_V15;
.
/
...
CREATE OR REPLACE PACKAGE "PROCS_SUBSCRIPTION_CRU_V15" AS 
...
END PROCS_SUBSCRIPTION_CRU_V15;
.
/
...
CREATE OR REPLACE PACKAGE "PROCS_SUBSCRIPTION_V15" AS
...
PROCEDURE START_SUBSCRIPTION_CREATION (
  ...
  in_check_dupe_products   IN NUMBER DEFAULT GLOBAL_CONSTANTS_V15.TRUE
);
...
PROCEDURE GET_CANCELLING_SSCRPTN_REASONS (
/*
Throws exceptions:
APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR
*/
...
*/
  in_invoice_id        IN NUMBER,
  in_updated_by        IN VARCHAR2,
  in_refundable        IN NUMBER DEFAULT GLOBAL_CONSTANTS_V15.FALSE
);
...
CREATE OR REPLACE PACKAGE "PROCS_SYSTEM_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_TAXES_CRU_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_TAXES_V15" AS 
...
PROCEDURE CHECK_COUNTRY_FOR_EXCLUSION (
  ...
  out_is_founded  OUT NUMBER -- GLOBAL_CONSTANT.TRUE of GLOBAL_CONSTANTS_V15.FALSE
);
...
CREATE OR REPLACE PACKAGE "PROCS_TEST_V15" AS 
...
CREATE OR REPLACE PACKAGE "PROCS_TRANSACTION_CRU_V15" AS 
...
PROCEDURE CREATE_TRANSACTION (
  ...
  in_order_id              IN TRANSACTION.ORDER_ID%TYPE,
  in_is_refund             IN TRANSACTION.IS_REFUND%TYPE DEFAULT GLOBAL_CONSTANTS_V15.FALSE
);
...
Throws exceptions:
APP_EXCEPTION_CODES_V15.NOT_FOUND
APP_EXCEPTION_CODES_V15.INTRNAL_ERROR
APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR
*/
  in_transaction_id IN TRANSACTION.ID%TYPE,
  in_order_id       IN TRANSACTION.ORDER_ID%TYPE,
...
CREATE OR REPLACE PACKAGE "PROCS_TRANSACTION_V15" AS 
...
*/
  ...
  in_created_by      IN VARCHAR2,
  in_order_id        IN VARCHAR2,
  in_is_refund       IN NUMBER DEFAULT GLOBAL_CONSTANTS_V15.FALSE,
...
CREATE OR REPLACE PACKAGE "PUBLIC_PROCS_BILLING_V15" AS 
...
CREATE OR REPLACE PACKAGE "PUBLIC_PROCS_NOTIFICATION_V15" AS 
...
END PUBLIC_PROCS_NOTIFICATION_V15;
.
/
...
CREATE OR REPLACE PACKAGE "PUBLIC_PROCS_RENEWAL_V15" AS 
...
END PUBLIC_PROCS_RENEWAL_V15;
.
/

CREATE OR REPLACE PACKAGE BODY "PROCS_ACCOUNT_CRU_V15" AS
...
BEGIN
  ...
  -- CREATE HISTORY
  PROCS_HISTORY_V15.CREATE_ACCOUNT_HISTORY(
    in_account_id                => in_account_id,
    in_system_activity_reason_id => GLOBAL_ENUMS_V15.SAC_SYSTEM_APPLIED_RULE
  );
...
CREATE OR REPLACE PACKAGE BODY "PROCS_ADDRESS_CRU_V15" AS
...
BEGIN
  ...
  -- Create history
  PROCS_HISTORY_V15.CREATE_ADDRESS_HISTORY(
...
CREATE OR REPLACE PACKAGE BODY "PROCS_AMAZON_CRU_V15" AS
...
BEGIN
  ...
  WHERE
    ...
    and s.subscription_status_id = GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE;
...
WHEN AMAZON_SUB_USED THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.DUPLICATE_ERROR,
    SPROC_NAME, 'Amazon sub already used', SQLERRM);
WHEN DUP_VAL_ON_INDEX THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.DUPLICATE_ERROR,
    SPROC_NAME, 'Duplicate value', SQLERRM);
WHEN OTHERS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
...
CREATE OR REPLACE PACKAGE BODY "PROCS_CHARGE_CRU_V15" AS
...
BEGIN
  ...
  -- Create history
  PROCS_HISTORY_V15.CREATE_CHARGE_HISTORY(
...
CREATE OR REPLACE PACKAGE BODY "PROCS_FIN_INSTRUMENTS_CRU_V15" AS
...
BEGIN
  ...
  -- Create history
  PROCS_HISTORY_V15.CREATE_CREDIT_CARD_HISTORY(
...
BEGIN
  -- Create history
  PROCS_HISTORY_V15.CREATE_PAYPAL_HISTORY(
...
BEGIN
  ...
  -- Create history
  PROCS_HISTORY_V15.CREATE_GIFT_CERT_HISTORY(
...
CREATE OR REPLACE PACKAGE BODY "PROCS_GROUP_ACCOUNT_CRU_V15" AS
...
EXCEPTION
  WHEN OTHERS THEN
    Procs_Common_V15.Throw_Exception(APP_EXCEPTION_CODES_V15.Internal_Error,
...
BEGIN
  ...
  set
    IR.GROUP_ACC_IP_RNG_STATUS_ID = GLOBAL_STATUSES_V15.GROUP_ACC_IP_RNG_INACTIVE,
    IR.UPDATED_BY = in_updated_by,
    IR.UPDATE_DATE = sysdate
  where
    IR.GROUP_ACCOUNT_ID = in_group_account_id and
    IR.GROUP_ACC_IP_RNG_STATUS_ID = GLOBAL_STATUSES_V15.GROUP_ACC_IP_RNG_ACTIVE
  ;
EXCEPTION
WHEN OTHERS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
...
BEGIN
    ...
    VALUES (
      ...
      in_created_by,
      sysdate,
      GLOBAL_STATUSES_V15.GROUP_ACC_IP_RNG_ACTIVE
    );
EXCEPTION
WHEN OTHERS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
...
BEGIN
  ...
  set
    ED.IS_ACTIVE = GLOBAL_STATUSES_V15.GROUP_ACC_EMAIL_DOMAIN_INACT,
    ED.UPDATED_BY = in_updated_by,
    ED.UPDATE_DATE = sysdate
  where
    ED.GROUP_ACCOUNT_ID = in_group_account_id and
    ED.IS_ACTIVE = GLOBAL_STATUSES_V15.GROUP_ACC_EMAIL_DOMAIN_ACT
  ;
EXCEPTION
WHEN OTHERS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
...
EXCEPTION
WHEN DUP_VAL_ON_INDEX THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.INVALID_PARAMETER,
...
BEGIN
  ...
  if(sql%rowcount = 0) then
    PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.NOT_FOUND,
...
BEGIN
  ...
  PROCS_SUBSCRIPTION_V15.ANNOTATE_SUBSCRIPTION(
...
CREATE OR REPLACE PACKAGE BODY "PROCS_INVOICE_CRU_V15" AS
...
BEGIN
  -- Create history
  PROCS_HISTORY_V15.CREATE_INVOICE_HISTORY(
...
CREATE OR REPLACE PACKAGE BODY "PROCS_ITUNES_RECEIPT_CRU_V15" AS
...
BEGIN
  ...
  WHERE
    ...
    S.SUBSCRIPTION_STATUS_ID = GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE;
...
BEGIN
  ...
  FOR REC IN (SELECT * FROM CORE_OWNER.ITUNES_RECEIPT WHERE ID = in_id) LOOP
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_ITUNES_RECEIPT_HISTORY
    (
        rec.id,
        rec.subscription_id,
        rec.receipt,
...
CREATE OR REPLACE PACKAGE BODY "PROCS_LICENSE_CRU_V15" AS
...
BEGIN
  -- Create history
  PROCS_HISTORY_V15.CREATE_LICENSE_HISTORY(
...
CREATE OR REPLACE PACKAGE BODY "PROCS_LINE_ITEMS_CRU_V15" AS
...
CREATE OR REPLACE PACKAGE BODY "PROCS_RECONCILIATION_CRU_V15" AS
...
CREATE OR REPLACE PACKAGE BODY "PROCS_SUBSCRIPTION_CRU_V15" AS
...
BEGIN
  -- Create history
  PROCS_HISTORY_V15.CREATE_SUBSCRIPTION_HISTORY(
...
CREATE OR REPLACE PACKAGE BODY "PROCS_TAXES_CRU_V15" AS
...
CREATE OR REPLACE PACKAGE BODY "PROCS_TRANSACTION_CRU_V15" AS
...
BEGIN
  -- Create history
  PROCS_HISTORY_V15.CREATE_TRANSACTION_HISTORY(
...
CREATE OR REPLACE PACKAGE BODY "PROCS_ADDRESS_V15" AS
...
BEGIN
  ...
  CORE_OWNER.PROCS_ADDRESS_CRU_V15.CREATE_ADDRESS(
...
BEGIN
  CORE_OWNER.PROCS_ADDRESS_CRU_V15.UPDATE_ADDRESS(
    in_address_id         => in_address_id,
    in_address1           => in_address1,
    in_address2           => in_address2,
    in_city               => in_city,
...
CREATE OR REPLACE PACKAGE BODY "PROCS_ADJUSTMENTS_V15" AS
...
BEGIN
  ...
  IF in_is_credit != GLOBAL_CONSTANTS_V15.TRUE AND in_is_credit != GLOBAL_CONSTANTS_V15.FALSE THEN
...
CREATE OR REPLACE PACKAGE BODY "PROCS_ADX_V15" AS
...
CREATE OR REPLACE PACKAGE BODY "PROCS_AMAZON_V15" AS
...
BEGIN
  ...
  CORE_OWNER.PROCS_AMAZON_CRU_V15.CREATE_AMAZON_SUB(
    out_id              =>  out_id,
    in_subscription_id  =>  in_subscription_id,
...
CREATE OR REPLACE PACKAGE BODY "PROCS_CUPY" AS
  ...
  BEGIN
    ...
    UPDATED_BY = in_updated_by,
    CREDIT_CARD_STATUS_ID = GLOBAL_STATUSES_V15.CREDIT_CARD_DISABLED
...
CREATE OR REPLACE
PACKAGE BODY PROCS_ENTITLEMENT_V15 AS
...
CREATE OR REPLACE PACKAGE BODY "PROCS_HISTORY_V15" AS
...
BEGIN
  ...
  BEGIN
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_ADDRESS_HISTORY(
      in_address_id,
...
BEGIN
  ...
  BEGIN
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_ACCOUNT_HISTORY(
      in_account_id,
      var_suspend_date,
      var_group_id,
      var_updated_by,
...
BEGIN
  ...
  BEGIN
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_SUBSCRIPTION_HISTORY(
      in_subscription_id,
      var_account_id,
      var_purchase_date,
      var_offer_chain_id,
...
BEGIN
  ...
  BEGIN    
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_CREDIT_CARD_HISTORY(
      in_credit_card_id,
      var_account_id,
      var_instrument_name,
      var_private_card_holder_name,
...
BEGIN
  ...
  BEGIN
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_PAYPAL_HISTORY(
      in_paypal_id,
      var_account_id,
      var_instrument_name,
      var_private_email_address,
...
BEGIN
  ...
  BEGIN
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_GIFT_CERT_HISTORY(
...
-- VARIABLES
var_transaction_status_id NUMBER;
var_transaction_amount    NUMBER(10,2);
var_updated_by            VARCHAR2(255);
var_update_date           DATE;
-- EXCEPTIONS
BAD_TRANSACTION_ID     EXCEPTION;
...
BEGIN
  ...
  BEGIN
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_TRANSACTION_HISTORY(
      in_transaction_id,
      var_transaction_status_id,
      var_transaction_amount,
      var_updated_by,
...
BEGIN
  ...
  BEGIN
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_INVOICE_HISTORY(
      in_invoice_id,
      var_invoice_status_id,
      var_updated_by,
      var_update_date,
...
BEGIN
  ...
  BEGIN
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_LICENSE_HISTORY(
      in_license_id,
      var_license_status_id,
      var_needs_entitlements,
      var_start_date,
...
BEGIN
  ...
  BEGIN
    CORE_HIST_OWNER.PUBLIC_PROCS_CORE_V15.CREATE_CHARGE_HISTORY (
      in_charge_id,
      var_invoice_id,
      var_transaction_id,
      var_instrument_type_id,
...
CREATE OR REPLACE PACKAGE BODY "PROCS_ITUNES_RECEIPT_V15" AS
...
BEGIN
  ...
  CORE_OWNER.PROCS_ITUNES_RECEIPT_CRU_V15.CREATE_RECEIPT(
    out_id              =>  out_id,
    in_subscription_id  =>  in_subscription_id,
...
BEGIN
  ...
  CORE_OWNER.PROCS_ITUNES_RECEIPT_CRU_V15.UPDATE_RECEIPT(
    in_id => in_id,
    in_receipt => in_receipt,
    in_status => in_status,
    in_quantity => in_quantity,
...
BEGIN
	CORE_OWNER.PROCS_ITUNES_RECEIPT_CRU_V15.LINK_ITUNES_RECEIPT(
		in_id => in_id,
		in_subscription_id => in_subscription_id,
		in_updated_by => in_updated_by
		);
...
BEGIN
  CORE_OWNER.PROCS_ITUNES_RECEIPT_CRU_V15.MARK_RECEIPT_CHECKED(
    in_id => in_id
  );
END MARK_RECEIPT_CHECKED;
...
(
  ...
  (
    ...
    WHERE
      ...
      (S.subscription_status_id in (GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED, GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE) or (S.subscription_status_id is null and IR.status != 21006)) AND
...
CREATE OR REPLACE PACKAGE BODY "PROCS_LINE_ITEMS_V15" AS
...
BEGIN
  ...
  LOOP
    ...
    var_line_item_price := PROCS_COMMON_V15.ROUND_10_6_TO_10_2(var_product_offering_price);
    ...
    PROCS_LINE_ITEMS_CRU_V15.CREATE_LINE_ITEM(
    ...
    LOOP
      PROCS_LINE_ITEMS_CRU_V15.CREATE_DISCOUNT_LINE_ITEM(
...
BEGIN
  ...
  -- Update line item
  PROCS_LINE_ITEMS_CRU_V15.UPDATE_LINE_ITEM(
...
BEGIN
  PROCS_LINE_ITEMS_V15.CALCULATE_LINE_ITEM_AMOUNT(in_line_item_id, var_invoice_amount);
...
CREATE OR REPLACE PACKAGE BODY "PROCS_LOCKING_V15" AS
...
WHEN ACCOUNT_ALREADY_INITIALIZED THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.STATE_ERROR,
...
CREATE OR REPLACE PACKAGE BODY "PROCS_OFFER_CHAIN_V15" AS
...
BEGIN
  ...
  SELECT
    ...
    PROCS_OFFER_CHAIN_V15.CALCULATE_OFFER_CHAIN_AMOUNT(OCH.ID) AS PRICE,
    PROCS_OFFER_CHAIN_V15.IS_OFFER_CHAIN_CANCELABLE(OCH.ID) AS IS_CANCELABLE,
...
BEGIN
  ...
  SELECT
    ...
    PROCS_OFFER_CHAIN_V15.CALCULATE_OFFER_AMOUNT(OOCH.OFFER_ID) AS PRICE
  FROM
    OFFER O
...
BEGIN
  ...
  SELECT
    ...
    OFFER_CHAIN.OFFER_CHAIN_STATUS_ID,
    OFFER_CHAIN.IS_GIFT_CERTIFICATE,
    PROCS_OFFER_CHAIN_V15.IS_OFFER_CHAIN_CANCELABLE(OFFER_CHAIN.ID) AS "IS_CANCELABLE",
  ...
  WHERE
    ...
    and OFFER_CHAIN.OFFER_CHAIN_STATUS_ID = GLOBAL_STATUSES_V15.OFFER_CHAIN_ACTIVE;
...
BEGIN
  ...
  WHERE
    OFFER_OFFER_CHAIN.OFFER_CHAIN_ID = in_offer_chain_id
    AND OFFER_OFFER_CHAIN.NUM_RECURRENCES = GLOBAL_ENUMS_V15.OFFER_REC_INFINITY;
  ...
  LOOP
    ...
    PROCS_COMMON_V15.ISO8601DURATION_TO_INTERVALS(var_offer_duration, var_offer_years, var_offer_months, var_offer_days);
...
BEGIN
  ...
  BEGIN
    PROCS_OFFER_CHAIN_V15.GET_FIRST_OFFER(
...
FUNCTION IS_OFFER_INDEX_EXISTS (
/*
GLOBAL_CONSTANTS_V15.TRUE - exists
GLOBAL_CONSTANTS_V15.FALSE - not exists
*/
  in_offer_chain_id          IN NUMBER,
  in_offer_chain_offer_index IN NUMBER
) RETURN NUMBER AS
...
BEGIN
  ...
  IF temp_count > 0 THEN
    RETURN GLOBAL_CONSTANTS_V15.TRUE;
  ELSE
    RETURN GLOBAL_CONSTANTS_V15.FALSE;
  END IF;
...
BEGIN
  ...
  BEGIN
    PROCS_COMMON_V15.ISO8601DURATION_TO_INTERVALS(
      var_offer_duration,
      out_years,
      out_months,
      out_days
...
BEGIN
  ...
  var_offer_end_date := ( ( in_start_date
    + GLOBAL_CONSTANTS_V15.ONE_DAY_INTERVAL * var_offer_days )
    + GLOBAL_CONSTANTS_V15.ONE_MONTH_INTERVAL * var_offer_months )
    + GLOBAL_CONSTANTS_V15.ONE_YEAR_INTERVAL * var_offer_years;
...
BEGIN
  ...
  PROCS_OFFER_CHAIN_V15.GET_OFF_CHAINS_SAME_PRODUCTS(
  ...
  LOOP
    ...
    IF in_use_eligibility_rules = GLOBAL_CONSTANTS_V15.FALSE THEN
    ...
    ELSE
      ...
      IF UPPER(s_product_eligibility_limit) = GLOBAL_CONSTANTS_V15.MAX_CONSURRENT_PRD_UNLIM THEN
        RETURN GLOBAL_CONSTANTS_V15.FALSE;
      END IF;
...
BEGIN
  ...
  BEGIN
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        var_is_cancelable := GLOBAL_CONSTANTS_V15.FALSE;
  END;

  IF var_is_cancelable = GLOBAL_CONSTANTS_V15.FALSE THEN
    RETURN GLOBAL_CONSTANTS_V15.FALSE;
  END IF;
...
BEGIN
  ...
  BEGIN
    ...
    WHERE
      NAME LIKE GLOBAL_CONSTANTS_V15.MAX_CONCURRENT_SUBS;

    IF var_max_concurrent_subs_str = GLOBAL_CONSTANTS_V15.MAX_CONCURRENT_SUBS_UNLIM THEN
      var_max_concurrent_subs := GLOBAL_CONSTANTS_V15.INFINITY;
    ELSE
...
BEGIN
  ...
  SELECT
    ...
    och.DESCRIPTION,
    och.OFFER_CHAIN_STATUS_ID,
    PROCS_OFFER_CHAIN_V15.CALCULATE_OFFER_CHAIN_AMOUNT(och.id) as amount,
    och.ADOPTABILITY_WINDOW_START_DATE,
    och.ADOPTABILITY_WINDOW_END_DATE,
    PROCS_OFFER_CHAIN_V15.IS_OFFER_CHAIN_CANCELABLE(och.id) as is_cancelable,
    och.IS_GIFT_CERTIFICATE,
  ...
  WHERE
    ...
    and och.OFFER_CHAIN_STATUS_ID = GLOBAL_STATUSES_V15.OFFER_CHAIN_ACTIVE
    and och.id in (
      SELECT DISTINCT
        och2.id
      from
...
BEGIN
  ...
  var_is_eligible := GLOBAL_CONSTANTS_V15.TRUE;
  ...
  IF (var_is_gc IS NULL OR var_is_gc != 1) THEN
    ...
    LOOP
      BEGIN
        IF (
          PROCS_OFFER_CHAIN_V15.CHECK_FOR_SAME_PRODUCTS(
            in_offer_chain_id,
            f_offer_chain.offer_chain_id,
            GLOBAL_CONSTANTS_V15.TRUE
          ) = GLOBAL_CONSTANTS_V15.TRUE
        ) THEN
          var_is_eligible := GLOBAL_CONSTANTS_V15.FALSE;
...
CREATE OR REPLACE PACKAGE BODY "PROCS_PRODUCT_V15" AS
    ...
    begin
        open out_cursor for
            ...
            select l.id license_id, l.start_date, l.end_date, l.offer_id, l.subscription_id, l.invoice_id
                  ...
                  ,l.current_offer_index, l.current_offer_recurr_num, l.entitlement_end_date
            from license l
                ,license_status ls
                ,ids
            where l.id = ids.id
...
CREATE OR REPLACE PACKAGE BODY "PROCS_SYSTEM_V15" AS
...
CREATE OR REPLACE PACKAGE BODY "PROCS_TAXES_V15" AS
...
BEGIN
  ...
  PROCS_TAXES_CRU_V15.CREATE_TAX(
    var_new_tax_id,
    in_tax_type_id,
    in_calculated_amount,
    in_created_by,
...
BEGIN
  ...
  IF var_countries_count > 1 THEN
    ...
    var_result := GLOBAL_CONSTANTS_V15.TRUE;
  ELSIF var_countries_count = 1 THEN
    var_result := GLOBAL_CONSTANTS_V15.TRUE;
  ELSE
    var_result := GLOBAL_CONSTANTS_V15.FALSE;
  END IF;
...
CREATE OR REPLACE PACKAGE BODY "PROCS_TRANSACTION_V15" AS
...
BEGIN
  ...
  PROCS_TRANSACTION_CRU_V15.CREATE_TRANSACTION(
...
BEGIN
  ...
  IF in_trans_attempt_status != GLOBAL_STATUSES_V15.TRANS_ATTEMPT_IN_PROGRESS
    AND in_trans_attempt_status != GLOBAL_STATUSES_V15.TRANS_ATTEMPT_SUCCESS
    AND in_trans_attempt_status != GLOBAL_STATUSES_V15.TRANS_ATTEMPT_FAILED THEN
    RAISE BAD_TRANS_ATTEMPT_STATUS;
  END IF;
  
  var_transaction_attempt_id := NULL;
  PROCS_TRANSACTION_CRU_V15.CREATE_TRANSACTION_ATTEMPT(
  ...
  PROCS_TRANSACTION_CRU_V15.UPDATE_TRANSACTION(
    in_transaction_id => in_transaction_id,
...
BEGIN
  ...
  -- Check that transaction status is correct
  IF    in_transaction_status_id != GLOBAL_STATUSES_V15.TRANSACTION_PENDING
    AND in_transaction_status_id != GLOBAL_STATUSES_V15.TRANSACTION_CLOSED
    AND in_transaction_status_id != GLOBAL_STATUSES_V15.TRANSACTION_CHARGEBACK
    AND in_transaction_status_id != GLOBAL_STATUSES_V15.TRANSACTION_DECLINED THEN
...
BEGIN
  ...
  IF in_transaction_attempt_status != GLOBAL_STATUSES_V15.TRANS_ATTEMPT_IN_PROGRESS
    AND in_transaction_attempt_status != GLOBAL_STATUSES_V15.TRANS_ATTEMPT_SUCCESS
    AND in_transaction_attempt_status != GLOBAL_STATUSES_V15.TRANS_ATTEMPT_FAILED THEN
    RAISE BAD_TRANS_ATTEMPT_STATUS;
  END IF;

  PROCS_TRANSACTION_CRU_V15.UPDATE_TRANSACTION_ATTEMPT(
...
BEGIN
  ...
  WHERE
    TRANSACTION_ATTEMPT.TRANSACTION_ID = in_transaction_id
    AND TRANSACTION_ATTEMPT.TRANSACTION_ATTEMPT_STATUS_ID = GLOBAL_STATUSES_V15.TRANS_ATTEMPT_FAILED;
...
BEGIN
  ...
  WHERE
    TRANSACTION_ATTEMPT.TRANSACTION_ID = in_transaction_id
    AND TRANSACTION_ATTEMPT.TRANSACTION_ATTEMPT_STATUS_ID = GLOBAL_STATUSES_V15.TRANS_ATTEMPT_SUCCESS;
...
BEGIN
  ...
  WHERE
    INVOICE.ID = in_invoice_id
    AND TRANSACTION.IS_REFUND = GLOBAL_CONSTANTS_V15.TRUE
    AND TRANSACTION.TRANSACTION_AMOUNT <= 0
    AND TRANSACTION.TRANSACTION_STATUS_ID = GLOBAL_STATUSES_V15.TRANSACTION_CLOSED;
...
BEGIN
  ...
  PROCS_TRANSACTION_CRU_V15.READ_TRANSACTION(
    in_transaction_id => in_transaction_id,
...
BEGIN
  ...
  BEGIN
    PROCS_TRANSACTION_CRU_V15.UPDATE_TRANSACTION_ORDER_ID(
      in_transaction_id => in_transaction_id,
      in_order_id       => in_order_id,
      in_updated_by     => in_updated_by
    );
    EXCEPTION
      WHEN OTHERS THEN
        IF SQLCODE = APP_EXCEPTION_CODES_V15.NOT_FOUND THEN
...
BEGIN
  ...
  WHERE
    ...
    AND T.TAX_TYPE_ID IN (
      SELECT GLOBAL_ENUMS_V15.TAX_TYPE_VAT FROM DUAL
    );
...
BEGIN
  ...
  WHERE
    TRANSACTION_ATTEMPT.TRANSACTION_ID = in_transaction_id
    AND TRANSACTION_ATTEMPT.TRANSACTION_ATTEMPT_STATUS_ID IN ( SELECT GLOBAL_STATUSES_V15.TRANS_ATTEMPT_SUCCESS FROM DUAL );
...
-- VARIABLES
SPROC_NAME     CONSTANT VARCHAR2(29) := 'GET_ATTEMPT_NUMBER';
temp_transaction_id NUMBER;
-- EXCEPTIONS
BAD_CHARGE_ID EXCEPTION;
BEGIN
...
CREATE OR REPLACE PACKAGE BODY "PROCS_LICENSE_V15" AS
...
BEGIN
  ...
  PROCS_LICENSE_CRU_V15.CREATE_LICENSE(
...
BEGIN
  ...
  IF in_license_status != GLOBAL_STATUSES_V15.LICENSE_CLOSED
     AND in_license_status != GLOBAL_STATUSES_V15.LICENSE_ACTIVE THEN
    RAISE BAD_LICENSE_STATUS;
  END IF;

  IF (in_ent_end is not null and in_ent_end = GLOBAL_CONSTANTS_V15.TRUE) then
    PROCS_LICENSE_CRU_V15.UPDATE_LICENSE(
      in_license_id        => in_license_id,
      in_updated_by        => in_updated_by,
...
(
  ...
  WHERE
    ...
    AND LICENSE.LICENSE_STATUS_ID = GLOBAL_STATUSES_V15.LICENSE_ACTIVE
    AND NOT EXISTS
    (
      SELECT NULL
      FROM OPS_OWNER.PROCESS_RETRY_THROTTLE
...
BEGIN
  ...
  BEGIN  
    var_next_offer_index := PROCS_OFFER_CHAIN_V15.GET_NEXT_OFFER_INDEX(
      var_offer_chain_id,
      var_license_current_index
    );
    EXCEPTION
...
(
  ...
  FROM
    LICENSE
  WHERE
    LICENSE.NEEDS_ENTITLEMENTS = GLOBAL_CONSTANTS_V15.TRUE
  AND ROWNUM <= 5000
  ORDER BY dbms_random.value
) WHERE
  ROWNUM <= 500;
...
BEGIN
  ...
  IF in_needs_entitlements != GLOBAL_CONSTANTS_V15.TRUE
    AND in_needs_entitlements != GLOBAL_CONSTANTS_V15.FALSE THEN
...
(
  ...
  WHERE
    l.LICENSE_STATUS_ID != GLOBAL_STATUSES_V15.LICENSE_ACTIVE
    AND l.ENTITLEMENT_END_DATE <= (current_timestamp)
    AND l.ENTITLEMENT_END_DATE > (current_timestamp - var_time_interval)
    AND s.subscription_status_id = GLOBAL_STATUSES_V15.SUBSCRIPTION_CLOSED
    AND NOT EXISTS (
      SELECT NULL
      FROM OPS_OWNER.PROCESS_RETRY_THROTTLE
      WHERE PROCESS_NAME = in_process_name
...
BEGIN
  ...
  PROCS_LICENSE_CRU_V15.UPDATE_LICENSE(
    ...
    in_updated_by        => in_updated_by,
    in_needs_entitlements => GLOBAL_CONSTANTS_V15.TRUE,
...
CREATE OR REPLACE PACKAGE BODY "PROCS_CHARGE_V15" AS
...
BEGIN
  ...
  IF in_instrument_type_id != GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD
    AND in_instrument_type_id != GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL THEN
    RAISE BAD_INSTRUMENT_TYPE;
  END IF;

  -- Check that status is correct
  IF in_charge_status_id != GLOBAL_STATUSES_V15.CHARGE_OPENED
    AND in_charge_status_id != GLOBAL_STATUSES_V15.CHARGE_PROCESSED
    AND in_charge_status_id != GLOBAL_STATUSES_V15.CHARGE_CANCELED THEN
  ...
  IF in_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD THEN
    IF PROCS_FIN_INSTRUMENTS_V15.IS_CREDIT_CARD_EXISTS(in_instrument_id) = GLOBAL_CONSTANTS_V15.FALSE THEN
      RAISE BAD_CREDIT_CARD_ID;
    END IF;
  ELSIF in_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL THEN
    IF PROCS_FIN_INSTRUMENTS_V15.IS_PAYPAL_EXISTS(in_instrument_id) = GLOBAL_CONSTANTS_V15.FALSE THEN
      RAISE BAD_PAYPAL_ID;
    END IF;
  END IF;

  -- Create new charge
  PROCS_CHARGE_CRU_V15.CREATE_CHARGE(
...
(
  ...
  FROM
    ...
    INNER JOIN TRANSACTION ON CHARGE.TRANSACTION_ID = TRANSACTION.ID
  WHERE
    TRANSACTION.TRANSACTION_STATUS_ID = GLOBAL_STATUSES_V15.TRANSACTION_PENDING
    AND TRANSACTION.IS_REFUND = GLOBAL_CONSTANTS_V15.TRUE
    AND TRANSACTION.TRANSACTION_AMOUNT < 0
    AND NOT EXISTS
    (
...
BEGIN
  ...
  WHERE
    ...
    AND CHARGE.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_OPENED
    AND 
      TRANSACTION.TRANSACTION_STATUS_ID = GLOBAL_STATUSES_V15.TRANSACTION_PENDING;
...
BEGIN
  ...
  WHERE
    CHARGE.INVOICE_ID = in_invoice_id
    AND CHARGE.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_PROCESSED
    AND TRANSACTION.TRANSACTION_STATUS_ID = GLOBAL_STATUSES_V15.TRANSACTION_CLOSED;
...
BEGIN
  ...
  PROCS_CHARGE_CRU_V15.UPDATE_CHARGE(
    in_charge_id        => in_charge_id,
    in_charge_status_id => in_charge_status_id,
    in_updated_by       => in_updated_by
  );
...
BEGIN
  ...
  BEGIN
    is_transaction_collected := PROCS_TRANSACTION_V15.IS_TRANSACTION_COLLECTED(var_transaction_id);
    EXCEPTION
      WHEN OTHERS THEN
        EXCEPTION_MESSAGE := SQLERRM;
...
BEGIN
  ...
  WHERE
    CHARGE.INVOICE_ID = in_invoice_id
    AND CHARGE.CHARGE_STATUS_ID IN (SELECT GLOBAL_STATUSES_V15.CHARGE_PROCESSED FROM DUAL)
    AND PROCS_CHARGE_V15.IS_CHARGE_COLLECTED(CHARGE.ID) = GLOBAL_CONSTANTS_V15.TRUE;
...
CREATE OR REPLACE PACKAGE BODY "PROCS_SUBSCRIPTION_V15" AS
...
BEGIN
  ...
  IF var_account_status = GLOBAL_STATUSES_V15.ACCOUNT_DISABLED THEN
  ...
  IF var_offer_chain_status_id != GLOBAL_STATUSES_V15.OFFER_CHAIN_ACTIVE THEN
    RAISE BAD_OFFER_CHAIN_STATUS;
  END IF;

  -- Can not subscribe to Offer Chain for a Gift Certfiicate
  IF var_is_gift_certificate = GLOBAL_CONSTANTS_V15.TRUE THEN
  ...
  WHERE
    OFFER_CHAIN_ELIGIBILITY.OFFER_CHAIN_ID = in_offer_chain_id
    AND OFFER_CHAIN_ELIGIBILITY.NAME = GLOBAL_CONSTANTS_V15.GIFT_CERTIFICATE_REQUIRED
    AND OFFER_CHAIN_ELIGIBILITY.VALUE = GLOBAL_CONSTANTS_V15.ELIGIBILITY_FLAG_SET;
  ...
  WHERE
    ...
    AND SUBSCRIPTION.SUBSCRIPTION_STATUS_ID = GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE;
  ...
  -- then deny purchase
  var_max_concurrent_subscrs := PROCS_OFFER_CHAIN_V15.GET_OFFER_CHAIN_MAX_CONC_SUBSC(in_offer_chain_id);
  IF var_max_concurrent_subscrs != GLOBAL_CONSTANTS_V15.INFINITY
  ...
  -- then deny purchase
  IF (in_check_dupe_products != GLOBAL_CONSTANTS_V15.FALSE) THEN
    FOR f_account_offer_chains IN (
      ...
      WHERE
        ...
        AND (
          SUBSCRIPTION_STATUS_ID = GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE
          OR SUBSCRIPTION_STATUS_ID = GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED)
    )
    LOOP
      IF PROCS_OFFER_CHAIN_V15.CHECK_FOR_SAME_PRODUCTS(
        in_offer_chain_1         => in_offer_chain_id,
        in_offer_chain_2         => f_account_offer_chains.OFFER_CHAIN_ID,
        in_use_eligibility_rules => GLOBAL_CONSTANTS_V15.TRUE
      ) = GLOBAL_CONSTANTS_V15.TRUE THEN
        ...
        FROM (
          ...
          WHERE
            ...
            AND (
              SUBSCRIPTION.SUBSCRIPTION_STATUS_ID = GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE
              OR SUBSCRIPTION.SUBSCRIPTION_STATUS_ID = GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED
            )
          ORDER BY
            ID
        )
  ...
  BEGIN
    PROCS_OFFER_CHAIN_V15.GET_FIRST_OFFER(in_offer_chain_id, var_first_offer_id);
    EXCEPTION
      WHEN OTHERS THEN
        EXCEPTION_MESSAGE := SQLERRM;
  ...
  BEGIN
    PROCS_INVOICE_V15.CREATE_INVOICE(
      in_invoice_status => GLOBAL_STATUSES_V15.INVOICE_OPEN,
      in_created_by     => in_created_by,
  ...
  BEGIN
    PROCS_LINE_ITEMS_V15.ADD_LINE_ITEMS(
  ...
  PROCS_SUBSCRIPTION_CRU_V15.CREATE_SUBSCRIPTION(
    out_subscription_id       => var_new_subscription_id,
    ...
    in_instrument_type_id     => in_instrument_type_id,
    in_instrument_id          => in_instrument_id,
    in_subscription_status_id => GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE
  );
  ...
  BEGIN
    PROCS_LICENSE_V15.CREATE_LICENSE(
      in_status_id                => GLOBAL_STATUSES_V15.LICENSE_ACTIVE,
      in_needs_entitlements       => GLOBAL_CONSTANTS_V15.TRUE,
      ...
      in_invoice_id               => var_new_invoice_id,
      in_created_by               => in_created_by,
      in_is_extension             => GLOBAL_CONSTANTS_V15.FALSE,
      in_current_offer_index      => PROCS_OFFER_CHAIN_V15.GET_FIRST_OFFER_INDEX(in_offer_chain_id),
...
WHEN LIMIT_REACHED THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.CONFLICT_ERROR,
...
BEGIN
  ...
  BEGIN
    PROCS_INVOICE_V15.CALCULATE_INVOICE_AMOUNT(
      in_invoice_id => in_invoice_id,
  ...
  IF in_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_ZCI_INSTRUMENT
  ...
  IF var_invoice_amount = 0 THEN
    ...
    PROCS_INVOICE_CRU_V15.UPDATE_INVOICE(
      in_invoice_id                  => in_invoice_id,
      in_updated_by                  => in_created_by,
      in_invoice_status_id           => GLOBAL_STATUSES_V15.INVOICE_CLOSED
    );
  ELSE
    -- Create transaction and charge
    BEGIN
      PROCS_TRANSACTION_V15.CREATE_TRANSACTION(
        in_transaction_id  => NULL,
        in_status_id       => GLOBAL_STATUSES_V15.TRANSACTION_PENDING,
    ...
    BEGIN
      PROCS_CHARGE_V15.CREATE_CHARGE(
        in_invoice_id         => in_invoice_id,
        ...
        in_created_by         => in_created_by,
        in_charge_status_id   => GLOBAL_STATUSES_V15.CHARGE_OPENED,
        out_charge_id         => var_new_charge_id
      );
      EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
  ...
  IF var_subscription_status_id != GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE THEN
  ...
  PROCS_LICENSE_CRU_V15.UPDATE_LICENSE(
    ...
    in_updated_by        => in_updated_by,
    in_license_status_id => GLOBAL_STATUSES_V15.LICENSE_CLOSED
  );
  ...
  PROCS_SUBSCRIPTION_CRU_V15.UPDATE_SUBSCRIPTION(
    in_subscription_id           => in_subs_id,
    in_updated_by                => in_updated_by,
    in_suspend_date              => SYSDATE,
    in_subscription_status_id    => GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED,
...
BEGIN
  ...
  SELECT
    ...
    --PROCS_OFFER_CHAIN_V15.CALCULATE_OFFER_CHAIN_END_DATE(OFFER_CHAIN.ID, SUBSCRIPTION.PURCHASE_DATE) as "END_DATE",
    PROCS_SUBSCRIPTION_V15.CALC_SUBSCRIPTION_END_DATE(SUBSCRIPTION.ID) as "END_DATE",
    PROCS_SUBSCRIPTION_V15.GET_RECENT_CHARGE(SUBSCRIPTION.ID) AS "RECENT_CHARGE",
    PROCS_SUBSCRIPTION_V15.GET_RENEWAL_DATE(SUBSCRIPTION.ID) AS "RENEWAL_DATE",
    PROCS_SUBSCRIPTION_V15.GET_BILLING_CYCLE(SUBSCRIPTION.ID) AS "BILLING_CYCLE",
    (
      SELECT
        ACCOUNT.GROUP_ID
        FROM ACCOUNT
    ...
    as "ENT_START_DATE",
    PROCS_SUBSCRIPTION_V15.IS_SUBSCRIPTION_CANCELABLE(SUBSCRIPTION.ID) AS "IS_CANCELABLE",
    ...
    PROCS_GROUP_ACCOUNT_V15.F_GET_NUM_OCCUPIED_GROUP_SEATS(GROUP_ACCOUNT.ID) GA_SEATS_USED,
    GROUP_ACCOUNT.IP GA_IP,
    PROCS_SUBSCRIPTION_V15.GET_GIFT_CERT_CODE_BY_SUB_ID(SUBSCRIPTION.ID) gift_certificate_code 
  FROM
    SUBSCRIPTION
...
BEGIN
  ...
  PROCS_SUBSCRIPTION_CRU_V15.CREATE_SUBSCRIPTION_NOTE(
...
SPROC_NAME CONSTANT VARCHAR2(30) := 'GET_CANCELLING_SSCRPTN_REASONS';
BEGIN
  ...
  WHERE
    SUBSCRIPTION_CANCEL_REASON.CANCELATION_STATUS_ID = GLOBAL_STATUSES_V15.SUBSCR_CANC_REASON_ACTIVE;

EXCEPTION
WHEN OTHERS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
    SPROC_NAME, 'Unknown error', SQLERRM);
END GET_CANCELLING_SSCRPTN_REASONS;
...
BEGIN
  ...
  IF var_subscription_status != GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE THEN
    -- TODO: Is suspended subscription has renewal date? (For the phase II)
    -- AND var_subscription_status != GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED THEN
    RETURN NULL;
  END IF;
    ...
    FROM
      (
        ...
        FROM
          LICENSE
        WHERE
          LICENSE.LICENSE_STATUS_ID = GLOBAL_STATUSES_V15.LICENSE_ACTIVE
  ...
  IF PROCS_OFFER_CHAIN_V15.GET_NEXT_OFFER_INDEX(var_offer_chain_id, var_current_offer_index) IS NULL
...
BEGIN
  ...
  BEGIN
    ...
    WHERE
      -- TODO: Review
      -- LICENSE.LICENSE_STATUS_ID = GLOBAL_STATUSES_V15.LICENSE_PROCESSED
      -- AND
      SUBSCRIPTION.ID = in_subscription_id
      AND CHARGE.CHARGE_AMOUNT >= 0
      AND ROWNUM <= 1
...
BEGIN
  ...
  IF var_account_status_id = GLOBAL_STATUSES_V15.ACCOUNT_FROZEN THEN
  ...
  IF var_invoice_status_id != GLOBAL_STATUSES_V15.INVOICE_CLOSED THEN
  ...
  WHERE
    CHARGE.INVOICE_ID = in_invoice_id
    AND (
      CHARGE.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_OPENED
      OR CHARGE.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_PROCESSED
    )
    AND CHARGE.CHARGE_AMOUNT < 0;
  ...
  BEGIN
    PROCS_TRANSACTION_V15.CREATE_TRANSACTION(
      in_transaction_id  => NULL,
      in_status_id       => GLOBAL_STATUSES_V15.TRANSACTION_PREPARE,
      in_amount          => -in_refund_amount,
      in_created_by      => in_created_by,
      in_order_id        => NULL,
      in_is_refund       => GLOBAL_CONSTANTS_V15.TRUE,
      out_transaction_id => var_new_transaction_id
    );
    EXCEPTION
      WHEN OTHERS THEN
...
BEGIN
  ...
  var_current_date := PROCS_COMMON_V15.NORMALIZE_DATE(SYSDATE);
  ...
  BEGIN
    ...
    WHERE
      SUBSCRIPTION.ID = in_subscription_id
      AND PROCS_COMMON_V15.NORMALIZE_DATE(LICENSE.END_DATE) > var_current_date
      AND PROCS_COMMON_V15.NORMALIZE_DATE(LICENSE.START_DATE) <= var_current_date
      AND ROWNUM <= 1
    ORDER BY
      LICENSE.ID DESC;
    EXCEPTION
  ...
  BEGIN
    PROCS_INVOICE_V15.CREATE_INVOICE(
      in_invoice_status => GLOBAL_STATUSES_V15.INVOICE_CLOSED,
      in_created_by     => in_updated_by,
      in_tax_exempt_id  => var_account_tax_exempt_id,
  ...
  BEGIN
    PROCS_LICENSE_V15.CREATE_LICENSE (
      ...
      in_created_by               => in_updated_by,
      in_is_extension             => GLOBAL_CONSTANTS_V15.TRUE,
  ...
  IF PROCS_COMMON_V15.NORMALIZE_DATE(var_current_license_end_date) >
     PROCS_COMMON_V15.NORMALIZE_DATE(in_effective_start_date) THEN
    BEGIN
      PROCS_LICENSE_V15.CREATE_LICENSE (
        in_status_id                => GLOBAL_STATUSES_V15.LICENSE_ACTIVE,
        in_needs_entitlements       => GLOBAL_CONSTANTS_V15.TRUE,
...
BEGIN
  ...
  IF var_current_offer_rec_number > last_license_offer_recurr_num THEN
    BEGIN
      PROCS_OFFER_CHAIN_V15.GET_OFFER_LENGTH(
        last_license_offer_id,
        var_offer_years,
        var_offer_months,
        var_offer_days
...
--
RETURNS:
GLOBAL_CONSTANTS_V15.TRUE - if has,
GLOBAL_CONSTANTS_V15.FALSE - else
*/
  in_license_id IN  NUMBER,
  out_result    OUT NUMBER
...
BEGIN
  ...
  IF var_future_licenses_count > 0 THEN
    out_result := GLOBAL_CONSTANTS_V15.TRUE;
  ELSE
    out_result := GLOBAL_CONSTANTS_V15.FALSE;
  END IF;
...
BEGIN
  ...
  PROCS_SUBSCRIPTION_V15.UPDATE_SUBSCRIPTION_STATUS(
    in_subscription_id        => in_subscription_id,
    in_updated_by             => in_updated_by,
    in_subscription_status_id => GLOBAL_STATUSES_V15.SUBSCRIPTION_CLOSED
  );
...
BEGIN
  ...
  IF in_subscription_status_id != GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE
    AND in_subscription_status_id != GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED
    AND in_subscription_status_id != GLOBAL_STATUSES_V15.SUBSCRIPTION_CANCELED
    AND in_subscription_status_id != GLOBAL_STATUSES_V15.SUBSCRIPTION_CLOSED THEN
    RAISE BAD_STATUS_ID;
  END IF;
...
BEGIN
  ...
  select decode(count(1), 0, GLOBAL_CONSTANTS_V15.FALSE, GLOBAL_CONSTANTS_V15.TRUE) into var_revoke
  ...
  where
    ...
    oc.revoke_entitlements = GLOBAL_CONSTANTS_V15.TRUE and
    rownum < 2;

  var_billed := PROCS_INVOICE_V15.IS_INVOICE_PAYING_STARTED(in_invoice_id);
  var_refund := GLOBAL_CONSTANTS_V15.FALSE;

  -- Check that transaction for given invoice not started
  -- if refund enabled calculate and apply chargeback
  IF (
      var_billed = GLOBAL_CONSTANTS_V15.TRUE
    )THEN
    if (in_refundable = GLOBAL_CONSTANTS_V15.TRUE) then
      -- If started then we need to calculate refund
      BEGIN
        PROCS_INVOICE_V15.CALCULATE_INVOICE_CHARGEBACK(
          in_invoice_id,
          var_now,
      ...
      IF var_chargeback_amount > 0 THEN
        BEGIN
          PROCS_INVOICE_V15.APPLY_REFUND(
            in_invoice_id,
            var_chargeback_amount,
            in_updated_by,
        ...
        END;
        var_refund := GLOBAL_CONSTANTS_V15.TRUE;
      END IF;
    end if;
  ELSE

    FOR f_transaction_to_close IN (
      SELECT DISTINCT CHARGE.TRANSACTION_ID AS "ID" FROM CHARGE WHERE CHARGE.INVOICE_ID = in_invoice_id and CHARGE.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_OPENED
    )
    LOOP
      PROCS_TRANSACTION_V15.UPDATE_TRANSACTION_STATUS(
        in_transaction_id        => f_transaction_to_close.ID,
        in_updated_by            => in_updated_by,
        in_transaction_status_id => GLOBAL_STATUSES_V15.TRANSACTION_CLOSED
      );
    END LOOP;
    -- Needs to close charges. No refund.
    FOR f_charge_to_close IN (
      SELECT CHARGE.ID FROM CHARGE WHERE CHARGE.INVOICE_ID = in_invoice_id and CHARGE.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_OPENED
    )
    LOOP
      PROCS_CHARGE_V15.UPDATE_CHARGE_STATUS(
        in_charge_id        => f_charge_to_close.ID,
        in_updated_by       => in_updated_by,
        in_charge_status_id => GLOBAL_STATUSES_V15.CHARGE_CANCELED
      );
    END LOOP;

    PROCS_INVOICE_V15.UPDATE_INVOICE_STATUS(
      in_invoice_id                  => in_invoice_id,
      in_updated_by                  => in_updated_by,
      in_invoice_status_id           => GLOBAL_STATUSES_V15.INVOICE_CLOSED
    );
  ...
  END IF;
  -- update licenses
  IF(var_revoke = GLOBAL_CONSTANTS_V15.TRUE OR var_chargeback_amount > 0 OR var_billed = GLOBAL_CONSTANTS_V15.FALSE) THEN
    FOR f_license_to_cancel IN (
      SELECT LICENSE.ID FROM LICENSE WHERE LICENSE.INVOICE_ID = in_invoice_id AND LICENSE.LICENSE_STATUS_ID = GLOBAL_STATUSES_V15.LICENSE_ACTIVE
    )
    LOOP
      PROCS_LICENSE_CRU_V15.UPDATE_LICENSE(
...
BEGIN
  ...
  IF var_current_subscr_status != GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE
     AND var_current_subscr_status != GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED THEN
    RAISE BAD_SUBSCRIPTION_STATUS;
  END IF;
  ...
  BEGIN
    PROCS_SUBSCRIPTION_CRU_V15.UPDATE_SUBSCRIPTION(
      in_subscription_id        => in_subscription_id,
      in_subscription_status_id => GLOBAL_STATUSES_V15.SUBSCRIPTION_CANCELED,
...
BEGIN
  ...
  BEGIN
    PROCS_SUBSCRIPTION_CRU_V15.UPDATE_SUBSCRIPTION(
      in_subscription_id        => in_subscription_id,
      in_subscription_status_id => GLOBAL_STATUSES_V15.SUBSCRIPTION_FALSE_START,
      in_cancelation_date       => in_cancelation_date,
      in_updated_by             => in_updated_by,
...
BEGIN
  ...
  BEGIN
    ...
    EXCEPTION
        ...
        WHEN NO_DATA_FOUND THEN
            SELECT
                PROCS_OFFER_CHAIN_V15.IS_OFFER_CHAIN_CANCELABLE(offer_id)
...
BEGIN
  ...
  WHERE
    OFFER_PRODUCT_OFFERING.OFFER_ID IN (
      ...
      FROM
        SUBSCRIPTION
        JOIN LICENSE ON LICENSE.SUBSCRIPTION_ID = SUBSCRIPTION.ID AND LICENSE.NEEDS_ENTITLEMENTS = GLOBAL_CONSTANTS_V15.TRUE
      WHERE
        SUBSCRIPTION.ID = in_subscription_id
    );
...
BEGIN
  ...
  WHERE
    ...
    and l.license_status_id = GLOBAL_STATUSES_V15.LICENSE_ACTIVE
...
BEGIN
  ...
  FOR f_invoice IN (
    ...
    WHERE
      LICENSE.SUBSCRIPTION_ID = in_subscription_id
      AND LICENSE.LICENSE_STATUS_ID IN ( SELECT GLOBAL_STATUSES_V15.LICENSE_ACTIVE FROM DUAL )
  )
  LOOP
    ...
    LOOP
      ...
      IF f_charge.CHARGE_AMOUNT < 0
         AND f_charge.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_OPENED THEN
        var_local_result := GLOBAL_CONSTANTS_V15.TRUE;
      END IF;
...
BEGIN
  ...
  WHERE
    ...
    c.charge_status_id = GLOBAL_STATUSES_V15.CHARGE_OPENED and
    exists (
      select null
      from transaction t
      where
...
CREATE OR REPLACE PACKAGE BODY "PROCS_INVOICE_V15" AS
...
BEGIN
  ...
  PROCS_INVOICE_CRU_V15.CREATE_INVOICE(
    out_invoice_id                 => var_new_invoice_id,
    in_created_by                  => in_created_by,
...
(
  ...
  WHERE
    1 = 2 AND
    (
      INVOICE.INVOICE_STATUS_ID = GLOBAL_STATUSES_V15.INVOICE_OPEN
    )
    AND NOT EXISTS(
      SELECT 1 FROM CHARGE WHERE INVOICE_ID=INVOICE.ID AND CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_OPENED AND ROWNUM <= 1
    )
    AND EXISTS (
      SELECT 1 FROM CHARGE WHERE INVOICE_ID=INVOICE.ID AND CHARGE_STATUS_ID != GLOBAL_STATUSES_V15.CHARGE_OPENED AND ROWNUM <= 1
    )
...
BEGIN
  ...
  LOOP
    BEGIN
      PROCS_LINE_ITEMS_V15.CALCULATE_LINE_ITEM_AMOUNT(
...
BEGIN
  ...
  -- get group id
  BEGIN
    PROCS_INVOICE_V15.GET_ACCOUNT_BY_INVOICE_ID(in_invoice_id, out_group_id);
    EXCEPTION
      WHEN OTHERS THEN
        EXCEPTION_MESSAGE := SQLERRM;
        RAISE CAN_NOT_FIND_ACCOUNT;
  ...
  WHERE
    CHARGE.INVOICE_ID = in_invoice_id
    AND CHARGE.INSTRUMENT_TYPE_ID = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL;
  ...
  WHERE
    CHARGE.INVOICE_ID = in_invoice_id
    AND CHARGE.INSTRUMENT_TYPE_ID = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD;
  ...
  WHERE
    CHARGE.INVOICE_ID = in_invoice_id
    AND CHARGE.INSTRUMENT_TYPE_ID = GLOBAL_ENUMS_V15.INSTRUMENT_GIFT_CERTIFICATE;
...
BEGIN
  ...
  IF in_invoice_status_id != GLOBAL_STATUSES_V15.INVOICE_OPEN
    AND in_invoice_status_id != GLOBAL_STATUSES_V15.INVOICE_CLOSED THEN
...
BEGIN
  ...
  FROM
    ...
    CHARGE c
  WHERE
    ta.TRANSACTION_ATTEMPT_STATUS_ID = GLOBAL_STATUSES_V15.TRANS_ATTEMPT_SUCCESS and
    ta.transaction_id = t.id and
    c.transaction_id = t.id and
    t.is_refund = GLOBAL_CONSTANTS_V15.FALSE and
  ...
  WHERE
    c.transaction_id = t.id and
    t.is_refund = GLOBAL_CONSTANTS_V15.FALSE and
    t.is_settled = GLOBAL_CONSTANTS_V15.TRUE and
    c.invoice_id = in_invoice_id
  ;
...
BEGIN
  -- Just a wrapper
  out_is_started := PROCS_INVOICE_V15.IS_INVOICE_PAYING_STARTED(in_invoice_id);
...
BEGIN
  ...
  IF in_chargeback_date IS NULL THEN
    var_chargeback_date := PROCS_COMMON_V15.NORMALIZE_DATE(current_date);
  ELSE
    var_chargeback_date := PROCS_COMMON_V15.NORMALIZE_DATE(in_chargeback_date);
  END IF;
  ...
  var_invoice_start_date := PROCS_COMMON_V15.NORMALIZE_DATE(var_invoice_start_date);
  ...
  PROCS_OFFER_CHAIN_V15.GET_OFFER_LENGTH_IN_DAYS(
  ...
  PROCS_INVOICE_V15.GET_INVOICE_DAYS_USED_NUMBER(
    in_invoice_id      => in_invoice_id,
  ...
  PROCS_OFFER_CHAIN_V15.GET_OFFER_CHAIN_MD_VALUE(
    in_offer_chain_id => var_offer_chain_id,
    in_meta_data_name => GLOBAL_CONSTANTS_V15.OFFER_CHAIN_FULL_REFUND,
  ...
  PROCS_OFFER_CHAIN_V15.GET_OFFER_CHAIN_MD_VALUE(
    in_offer_chain_id => var_offer_chain_id,
    in_meta_data_name => GLOBAL_CONSTANTS_V15.OFFER_CHAIN_PRORATED_REFUND,
    out_value         => var_offer_chain_meta_data_val
  );
  IF var_offer_chain_meta_data_val IS NULL THEN
  ...
  var_chargeback_calculated := GLOBAL_CONSTANTS_V15.FALSE;
  
  IF var_offer_chain_full_refund IS NOT NULL
     AND var_chargeback_calculated = GLOBAL_CONSTANTS_V15.FALSE THEN
    IF var_license_days_used < var_offer_chain_full_refund THEN
      out_chargeback_amount := var_invoice_amount;
      var_chargeback_calculated := GLOBAL_CONSTANTS_V15.TRUE;
    END IF;
  END IF;
  ...
  IF var_chargeback_calculated = GLOBAL_CONSTANTS_V15.TRUE THEN
    PROCS_INVOICE_V15.GET_MAX_REFUND(
      in_invoice_id => in_invoice_id,
  ...
  IF var_chargeback_calculated = GLOBAL_CONSTANTS_V15.FALSE THEN
...
BEGIN
  ...
  LOOP
    ...
    IF f_charge.CHARGE_STATUS_ID != GLOBAL_STATUSES_V15.CHARGE_CANCELED THEN
    
      IF f_charge.CHARGE_AMOUNT > 0 THEN
        IF f_charge.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_PROCESSED
           AND PROCS_TRANSACTION_V15.IS_TRANSACTION_COLLECTED(f_charge.TRANSACTION_ID) = GLOBAL_CONSTANTS_V15.TRUE THEN
      ...
      ELSE
        IF f_charge.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_PROCESSED
           AND PROCS_TRANSACTION_V15.IS_TRANSACTION_COLLECTED(f_charge.TRANSACTION_ID) = GLOBAL_CONSTANTS_V15.FALSE THEN
...
BEGIN
  ...
  FOR f_license IN (
    ...
    WHERE
      LICENSE.INVOICE_ID = in_invoice_id
      AND LICENSE.IS_EXTENSION = GLOBAL_CONSTANTS_V15.FALSE
  )
  LOOP
    var_license_start_date := PROCS_COMMON_V15.NORMALIZE_DATE(f_license.START_DATE);
    var_license_end_date := PROCS_COMMON_V15.NORMALIZE_DATE(f_license.END_DATE);
...
BEGIN
  ...
  --    in_license_id         => f_license_to_cancel.ID,
  --    in_license_status_id  => GLOBAL_STATUSES_V15.LICENSE_CLOSED,
  --    in_needs_entitlements => GLOBAL_CONSTANTS_V15.FALSE,
  --    in_updated_by         => in_updated_by
  --  );
  --END LOOP;
...
BEGIN
  ...
  IF var_is_tax_exempt IS NULL THEN
    out_is_tax_exempt := GLOBAL_CONSTANTS_V15.FALSE;
  ELSE
    out_is_tax_exempt := GLOBAL_CONSTANTS_V15.TRUE;
  END IF;
...
BEGIN
  ...
  WHERE
    ...
    AND (
      CHARGE.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_OPENED
      OR (
        CHARGE.CHARGE_STATUS_ID = GLOBAL_STATUSES_V15.CHARGE_PROCESSED
        AND EXISTS (
          SELECT 1 FROM TRANSACTION_ATTEMPT ta where ta.transaction_id = CHARGE.TRANSACTION_ID and ta.transaction_attempt_status_id = GLOBAL_STATUSES_V15.TRANS_ATTEMPT_SUCCESS
        )
      )
    )
    AND CHARGE.CHARGE_AMOUNT < 0;
  ...
  FOR f_processed_charges IN (
    ...
    WHERE
      ...
      AND CHARGE.CHARGE_AMOUNT > 0
      AND CHARGE.CHARGE_STATUS_ID IN (SELECT GLOBAL_STATUSES_V15.CHARGE_PROCESSED FROM DUAL)
      AND EXISTS (SELECT 1 FROM TRANSACTION_ATTEMPT ta where ta.transaction_id = CHARGE.TRANSACTION_ID and ta.transaction_attempt_status_id = GLOBAL_STATUSES_V15.TRANS_ATTEMPT_SUCCESS)
  )
  LOOP
    var_charges_amount := var_charges_amount + f_processed_charges.CHARGE_AMOUNT;
  END LOOP;
...
BEGIN
  ...
  where
    ch.invoice_id = in_invoice_id
    and ta.transaction_attempt_status_id = GLOBAL_STATUSES_V15.TRANS_ATTEMPT_SUCCESS
...
BEGIN
  SELECT DECODE(COUNT(1), 0, GLOBAL_CONSTANTS_V15.FALSE, GLOBAL_CONSTANTS_V15.TRUE)
    into out_is_revoke
  FROM
    offer_chain oc,
    subscription s,
...
CREATE OR REPLACE PACKAGE BODY "PROCS_FIN_INSTRUMENTS_V15" AS
...
BEGIN
  FOR rec IN (SELECT id FROM Gift_Certificate WHERE Purchase_Invoice_Id = in_invoice_id) LOOP
    PROCS_FIN_INSTRUMENTS_CRU_V15.UPDATE_GIFT_CERTIFICATE (
  ...
  WHERE
    ...
    AND NOT EXISTS(
      ...
      WHERE
        ...
        ta.transaction_attempt_status_id = GLOBAL_STATUSES_V15.TRANS_ATTEMPT_SUCCESS
    ) AND NOT EXISTS (
      SELECT NULL
      FROM
        charge c,
      ...
      WHERE
        c.invoice_id = gc.purchase_invoice_id and
        c.transaction_id = t.id and
        t.is_refund = GLOBAL_CONSTANTS_V15.TRUE
    )
    AND ROWNUM <= in_num_rows*10
    ORDER BY dbms_random.value
) WHERE
...
BEGIN
  ...
  PROCS_FIN_INSTRUMENTS_CRU_V15.CREATE_CREDIT_CARD(
    out_credit_card_id          => var_credit_card_id,
    in_account_id               => var_account_id,
...
BEGIN
  ...
  IF in_paypal_status_id != GLOBAL_STATUSES_V15.PAYPAL_ACTIVE
    AND in_paypal_status_id != GLOBAL_STATUSES_V15.PAYPAL_INACTIVE
    AND in_paypal_status_id != GLOBAL_STATUSES_V15.PAYPAL_FROZEN THEN
  ...
  BEGIN
    PROCS_FIN_INSTRUMENTS_CRU_V15.CREATE_PAYPAL(
      out_paypal_id                  => var_paypal_id,
      in_paypal_id                   => NULL,
      in_account_id                  => var_account_id,
      in_instrument_name             => in_instrument_name,
...
BEGIN
  ...
  IF F_CAN_DISABLE_CREDIT_CARD(in_credit_card_id) = GLOBAL_CONSTANTS_V15.FALSE THEN
  ...
  IF var_credit_card_status != GLOBAL_STATUSES_V15.CREDIT_CARD_ACTIVE THEN
    RAISE BAD_CC_STATUS;
  END IF;
  ...
  FROM
    ...
    INNER JOIN TRANSACTION ON CHARGE.TRANSACTION_ID = TRANSACTION.ID
  WHERE
    CHARGE.INSTRUMENT_TYPE_ID = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD
    AND CHARGE.INSTRUMENT_ID = in_credit_card_id
    AND TRANSACTION.TRANSACTION_STATUS_ID = GLOBAL_STATUSES_V15.TRANSACTION_PENDING;
  ...
  IF current_def_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD
  ...
  PROCS_FIN_INSTRUMENTS_V15.UPDATE_CREDIT_CARD_STATUS(
    in_credit_card_id        => in_credit_card_id,
    in_updated_by            => in_updated_by,
    in_credit_card_status_id => GLOBAL_STATUSES_V15.CREDIT_CARD_DISABLED
  );
...
BEGIN
  ...
  IF var_paypal_status_id = GLOBAL_STATUSES_V15.PAYPAL_INACTIVE THEN
  ...
  FROM
    ...
    INNER JOIN TRANSACTION ON CHARGE.TRANSACTION_ID = TRANSACTION.ID
  WHERE
    CHARGE.INSTRUMENT_TYPE_ID = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL
  ...
  -- Checking that credit card is not default
  IF current_def_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL
  ...
  PROCS_FIN_INSTRUMENTS_V15.UPDATE_PAYPAL_STATUS(
    in_paypal_id        => in_paypal_id,
    in_updated_by       => in_updated_by,
    in_paypal_status_id => GLOBAL_STATUSES_V15.PAYPAL_INACTIVE
  );
...
BEGIN
  ...
  IF in_is_default != GLOBAL_CONSTANTS_V15.TRUE
    AND in_is_default != GLOBAL_CONSTANTS_V15.FALSE
  ...
  IF in_instrument_name IS NOT NULL THEN
    PROCS_FIN_INSTRUMENTS_CRU_V15.UPDATE_CREDIT_CARD(
      in_credit_card_id  => in_credit_card_id,
      in_updated_by      => in_updated_by,
      in_instrument_name => in_instrument_name
    );
  ...
  IF in_is_default = GLOBAL_CONSTANTS_V15.TRUE THEN
    BEGIN
      PROCS_FIN_INSTRUMENTS_V15.SET_DEF_FINANCIAL_INSTRUMENT(
        in_group_id           => var_group_id,
        in_instrument_type_id => GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD,
  ...
  -- Set default financial instrument
  IF in_is_default = GLOBAL_CONSTANTS_V15.FALSE THEN
    BEGIN
      GET_DEF_FINANCIAL_INSTRUMENT(
        in_group_id            => var_group_id,
        out_instrument_type_id => current_def_instrument_type_id,
...
BEGIN
  ...
  IF var_och_is_gc != GLOBAL_CONSTANTS_V15.TRUE
  ...
  PROCS_FIN_INSTRUMENTS_CRU_V15.CREATE_GIFT_CERTIFICATE(
    ...
    in_gift_certificate_status_id => GLOBAL_STATUSES_V15.GIFT_CERTIFICATE_ACTIVE,
...
BEGIN
  ...
  -- Check that instrument exists
  IF in_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD THEN
    IF IS_CREDIT_CARD_EXISTS(in_instrument_id) = GLOBAL_CONSTANTS_V15.FALSE THEN
      RAISE BAD_CREDIT_CARD_ID;
    END IF;
  ELSIF in_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL THEN
    IF IS_PAYPAL_EXISTS(in_instrument_id) = GLOBAL_CONSTANTS_V15.FALSE THEN
      RAISE BAD_PAYPAL_ID;
    END IF;
  ELSIF in_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_ZCI_INSTRUMENT THEN
    NULL;
  ELSE
    RAISE BAD_INSTRUMENT_TYPE;
  END IF;
  ...
  BEGIN
    PROCS_INVOICE_V15.CALCULATE_INVOICE_AMOUNT(in_invoice_id, var_invoice_amount);
    EXCEPTION
      WHEN OTHERS THEN
        EXCEPTION_MESSAGE := SQLERRM;
        RAISE CAN_NOT_CALC_INVOICE_AMOUNT;
  ...
  IF var_invoice_amount > 0
    AND in_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_ZCI_INSTRUMENT THEN
    RAISE CAN_NOT_USE_FCINSTR;
  END IF;
...
BEGIN
  ...
  -- Calculate new invoice amount
  BEGIN
    PROCS_INVOICE_V15.CALCULATE_INVOICE_AMOUNT(var_new_invoice_id, var_invoice_amount);
    EXCEPTION
      WHEN OTHERS THEN
        EXCEPTION_MESSAGE := SQLERRM;
        RAISE CAN_NOT_CALC_INVOICE_AMOUNT;
  ...
  IF var_oc_id_to_redeem IS NULL THEN
    BEGIN
      ...
      WHERE
        ...
        AND OFFER_CHAIN_META_DATA.NAME = GLOBAL_CONSTANTS_V15.REDEMPTION_OC_ID
        AND ROWNUM = 1;
...
--      AND ELIGIBILITY.NAME = GLOBAL_CONSTANTS_V15.GIFT_CERTIFICATE_REQUIRED
--      AND ELIGIBILITY.VALUE = GLOBAL_CONSTANTS_V15.ELIGIBILITY_FLAG_SET
...
--      AND ROWNUM = 1;
  ...
  IF var_gc_purchase_inv_status_id != GLOBAL_STATUSES_V15.INVOICE_CLOSED THEN
  ...
  IF var_succ_purch_attempts_num = 0 THEN
    ...
    FROM
      DUAL
    WHERE 
      PROCS_INVOICE_V15.F_CALCULATE_INVOICE_AMOUNT(var_gc_purchase_invoice_id) = 0;
  END IF;
  ...
  WHERE
    ...
    AND (
      SUBSCRIPTION.SUBSCRIPTION_STATUS_ID = GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE
      -- TODO: Does we need next line?
      -- OR SUBSCRIPTION.SUBSCRIPTION_STATUS_ID = GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED
    );
-- norlov: #38414 the same checking as on OC purchase (just copypasted from CREATE_SUBSCRIPTION - TODO: refactor it not to keep the same code twice)
--  IF PROCS_OFFER_CHAIN_V15.GET_OFFER_CHAIN_MAX_CONC_SUBSC(var_oc_id_to_redeem) = var_same_offer_chains_num THEN
--    RAISE LIMIT_REACHED;
--  END IF;
IF var_same_offer_chains_num = 0 THEN
    ...
    LOOP
      IF PROCS_OFFER_CHAIN_V15.CHECK_FOR_SAME_PRODUCTS(var_oc_id_to_redeem, f_account_offer_chains.OFFER_CHAIN_ID) = GLOBAL_CONSTANTS_V15.TRUE THEN
  ...
  ELSE
    ...
    -- and if MAX_CONCURRENT_SUBS <= [user's subscription count for the offer chain]
    -- then deny purchase
    var_max_concurrent_subscrs := PROCS_OFFER_CHAIN_V15.GET_OFFER_CHAIN_MAX_CONC_SUBSC(var_oc_id_to_redeem);
    IF var_max_concurrent_subscrs != GLOBAL_CONSTANTS_V15.INFINITY
      AND var_max_concurrent_subscrs <= var_same_offer_chains_num THEN
      RAISE LIMIT_REACHED;
    END IF;
...
-- norlov: END OF TODO  
  ...
  END IF;
   ...
   IF var_gc_status_id = GLOBAL_STATUSES_V15.GIFT_CERTIFICATE_REFUNDED THEN
    RAISE GIFT_CERT_IS_REFUNDED;
  END IF;
  
  IF var_gc_status_id = GLOBAL_STATUSES_V15.GIFT_CERTIFICATE_FINALIZED THEN
  ...
  LOOP
    IF PROCS_OFFER_CHAIN_V15.CHECK_FOR_SAME_PRODUCTS(var_oc_id_to_redeem, f_user_offer_chain.OFFER_CHAIN_ID)=GLOBAL_CONSTANTS_V15.TRUE THEN
      RAISE USER_ALREADY_SUBSCRIBED_TO_PRD;
    END IF;
  END LOOP;
  ...
  IF var_fin_instrument_id is null THEN
    ...
    var_fin_instrument_type_id := GLOBAL_ENUMS_V15.INSTRUMENT_GIFT_CERTIFICATE;
  END IF;
  ...
  BEGIN
    PROCS_OFFER_CHAIN_V15.GET_FIRST_OFFER(var_oc_id_to_redeem, var_first_offer_id);
    EXCEPTION
      WHEN OTHERS THEN
        EXCEPTION_MESSAGE := SQLERRM;
        RAISE CAN_NOT_GET_FIRST_OFFER_CHAIN;
  ...
  BEGIN
    PROCS_LICENSE_V15.CREATE_LICENSE (
      ...
      in_end_date                 => NULL, -- Will be calculated automatically
      in_is_extension             => GLOBAL_CONSTANTS_V15.FALSE,
      in_current_offer_index      => PROCS_OFFER_CHAIN_V15.GET_FIRST_OFFER_INDEX(var_oc_id_to_redeem),
      in_current_offer_recurr_num => 1
    );
  ...
  BEGIN
    PROCS_FIN_INSTRUMENTS_CRU_V15.UPDATE_GIFT_CERTIFICATE(
      ...
      in_gift_certificate_status_id => GLOBAL_STATUSES_V15.GIFT_CERTIFICATE_FINALIZED
    );
    EXCEPTION
      WHEN OTHERS THEN
        EXCEPTION_MESSAGE := SQLERRM;
...
BEGIN
  ...
  PROCS_ACCOUNT_CRU_V15.UPDATE_ACCOUNT(
    in_account_id         => var_account_id,
    in_updated_by         => in_updated_by,
    in_instrument_type_id => in_instrument_type_id,
    in_instrument_id      => in_instrument_id
...
BEGIN
  ...
  PROCS_ACCOUNT_CRU_V15.UPDATE_DEF_FIN_INSTRUMENT(
    in_account_id => var_account_id,
...
FUNCTION F_CAN_DISABLE_CREDIT_CARD (
/*
  Returns GLOBAL_CONSTANTS_V15.TRUE if system can disable credit card
  GLOBAL_CONSTANTS_V15.FALSE else
*/
  in_credit_card_id NUMBER
) RETURN NUMBER AS
...
FUNCTION IS_CREDIT_CARD_EXISTS (
/*
GLOBAL_CONSTANTS_V15.TRUE - if instrument exists
GLOBAL_CONSTANTS_V15.FALSE - else
*/
  in_credit_card_id IN NUMBER
) RETURN NUMBER AS
...
BEGIN
  ...
  IF in_credit_card_status_id != GLOBAL_STATUSES_V15.CREDIT_CARD_ACTIVE
    AND in_credit_card_status_id != GLOBAL_STATUSES_V15.CREDIT_CARD_INVALID
    AND in_credit_card_status_id != GLOBAL_STATUSES_V15.CREDIT_CARD_DISABLED
    AND in_credit_card_status_id != GLOBAL_STATUSES_V15.CREDIT_CARD_EXPIRED THEN
    RAISE BAD_STATUS_ID;
  END IF;
...
BEGIN
  ...
  PROCS_FIN_INSTRUMENTS_CRU_V15.UPDATE_PAYPAL(
    in_paypal_id        => in_paypal_id,
    in_paypal_status_id => in_paypal_status_id,
    in_updated_by       => in_updated_by
  );
...
BEGIN
  ...
  IF in_gift_certificate_status_id != GLOBAL_STATUSES_V15.GIFT_CERTIFICATE_ACTIVE
    AND in_gift_certificate_status_id != GLOBAL_STATUSES_V15.GIFT_CERTIFICATE_FINALIZED THEN
    RAISE BAD_STATUS_ID;
  END IF;
...
BEGIN
  ...
  IF in_old_fin_instrument_type = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD THEN
    IF PROCS_FIN_INSTRUMENTS_V15.IS_CREDIT_CARD_EXISTS(in_old_fin_instrument_id) = GLOBAL_CONSTANTS_V15.FALSE THEN
      -- throw exception: bad old credit card
      RAISE BAD_OLD_CC;
    END IF;
  ELSIF in_old_fin_instrument_type = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL THEN
    IF PROCS_FIN_INSTRUMENTS_V15.IS_PAYPAL_EXISTS(in_old_fin_instrument_id) = GLOBAL_CONSTANTS_V15.FALSE THEN
  ...
  IF in_new_fin_instrument_type = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD THEN
    IF PROCS_FIN_INSTRUMENTS_V15.IS_CREDIT_CARD_EXISTS(in_new_fin_instrument_id) = GLOBAL_CONSTANTS_V15.FALSE THEN
      -- throw exception: bad new credit card
      RAISE BAD_NEW_CC;
    END IF;
  ELSIF in_new_fin_instrument_type = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL THEN
    IF PROCS_FIN_INSTRUMENTS_V15.IS_PAYPAL_EXISTS(in_new_fin_instrument_id) = GLOBAL_CONSTANTS_V15.FALSE THEN
  ...
  SELECT count(1) into var_accounts_count FROM (
    ...
    WHERE
      (
        ...
        AND in_old_fin_instrument_type = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD
      )
      OR
      (
        CC.ID = in_new_fin_instrument_id
        AND in_new_fin_instrument_type = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD
      )
    UNION
    SELECT
      PP.ACCOUNT_ID
    ...
    WHERE
      (
        ...
        AND in_old_fin_instrument_type = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL
      )
      OR
      (
        PP.ID = in_new_fin_instrument_id
        AND in_new_fin_instrument_type = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL
      )
  )
  WHERE
  ...
  FOR f_sub IN (
    ...
    WHERE
      (
        s.subscription_status_id = GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE OR
        s.subscription_status_id = GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED
      )
      AND
  ...
  FOR f_open_charge IN (
    ...
    WHERE
      ...
      AND ch.charge_status_id = GLOBAL_STATUSES_V15.CHARGE_OPENED
  ) LOOP
    ...
    FOR f_pending_transaction IN (
      ...
      where
        ...
        and transaction_status_id = GLOBAL_STATUSES_V15.TRANSACTION_PENDING
    ) LOOP
      PROCS_TRANSACTION_V15.CREATE_TRANSACTION (
        in_transaction_id => NULL,
        in_status_id  => GLOBAL_STATUSES_V15.TRANSACTION_PENDING,
...
CREATE OR REPLACE PACKAGE BODY "PROCS_GROUP_ACCOUNT_V15" AS
...
BEGIN
  CORE_OWNER.PROCS_GROUP_ACCOUNT_CRU_V15.UPDATE_SUBSCRIPTION_SHARE (
...
BEGIN
  ...
  SELECT * FROM (
    ...
    WHERE
      ...
      AND Ss.Needs_Entitlements  = GLOBAL_CONSTANTS_V15.TRUE
...
BEGIN
  ...
  upper_bond_diff :=  range_diff - GLOBAL_CONSTANTS_V15.MAX_RETURN_COUNT;
...
BEGIN
  ...
  WHERE
   ...
   GROUP_ACC_IP_RNG_STATUS_ID = GLOBAL_STATUSES_V15.GROUP_ACC_IP_RNG_ACTIVE;
EXCEPTION
WHEN OTHERS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
...
BEGIN
  ...
  CORE_OWNER.PROCS_GROUP_ACCOUNT_CRU_V15.CREATE_GROUP_ACCOUNT(
    in_subscription_id => in_subscription_id,
...
SPROC_NAME CONSTANT VARCHAR2(32) := 'DISABLE_EMAIL_DOMAIN_BY_GA_ID';
BEGIN
    PROCS_GROUP_ACCOUNT_CRU_V15.DISABLE_EMAIL_DOMAIN_BY_GA_ID(
...
SPROC_NAME CONSTANT VARCHAR2(32) := 'DISABLE_EMAIL_DOMAIN_BY_ID';
BEGIN
    PROCS_GROUP_ACCOUNT_CRU_V15.DISABLE_EMAIL_DOMAIN_BY_ID(
      in_id => in_id,
      in_updated_by => in_updated_by
    );
EXCEPTION
...
BEGIN
    ...
    IF(var_group_account_count > 0) THEN
        ...
        WHERE
            ...
            rownum <= 1;
        PROCS_GROUP_ACCOUNT_CRU_V15.ENABLE_EMAIL_DOMAIN_BY_ID(
            in_id => var_id,
            in_updated_by => in_created_by
            );
    ELSE
        PROCS_GROUP_ACCOUNT_CRU_V15.ADD_EMAIL_DOMAIN(
            in_group_account_id => in_group_account_id,
            in_email_domain => in_email_domain,
	        in_is_active => GLOBAL_STATUSES_V15.GROUP_ACC_EMAIL_DOMAIN_ACT,
            in_created_by => in_created_by
        );
    END IF; 
...
BEGIN
  start_date := sysdate;
  end_date   := GLOBAL_CONSTANTS_V15.MAX_DATE;
  ...
  CORE_OWNER.PROCS_GROUP_ACCOUNT_CRU_V15.CREATE_SUBSCRIPTION_SHARE(
    in_group_account_id => in_group_account_id,
...
BEGIN
  SELECT 
    PROCS_GROUP_ACCOUNT_V15.F_GET_NUM_OCCUPIED_GROUP_SEATS(in_group_account_id) INTO out_occupied_seats
  FROM dual;
EXCEPTION
WHEN OTHERS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
...
SPROC_NAME CONSTANT VARCHAR2(32) := 'DISABLE_IP_RANGES_BY_GA_ID';
BEGIN
    PROCS_GROUP_ACCOUNT_CRU_V15.DISABLE_IP_RANGES_BY_GA_ID(
      in_group_account_id => in_group_account_id,
      in_updated_by => in_updated_by
    );
EXCEPTION
...
SPROC_NAME CONSTANT VARCHAR2(32) := 'DISABLE_IP_RANGE_BY_ID';
BEGIN
    PROCS_GROUP_ACCOUNT_CRU_V15.DISABLE_IP_RANGE_BY_ID(
      in_id => in_id,
      in_updated_by => in_updated_by
    );
EXCEPTION
...
BEGIN
    ...
    PROCS_GROUP_ACCOUNT_CRU_V15.ADD_IP_RANGE(
      in_group_account_id => in_group_account_id,
    ...
    FROM
      GROUP_ACCOUNT_IP_RANGE
    WHERE
      GROUP_ACC_IP_RNG_STATUS_ID = GLOBAL_STATUSES_V15.GROUP_ACC_IP_RNG_ACTIVE AND
          ((
...
BEGIN
  PROCS_GROUP_ACCOUNT_CRU_V15.UPDATE_GROUP_ACCOUNT(
    in_group_account_id => in_group_account_id,
    in_group_name => in_group_name,
    in_first_name => in_first_name,
    in_last_name => in_last_name,
...
BEGIN
  PROCS_GROUP_ACCOUNT_CRU_V15.UPDATE_GROUP_ACCOUNT_SEATS(
    in_group_account_id => in_group_account_id,
    in_seats => in_seats,
    in_updated_by => in_updated_by
  );
...
CREATE OR REPLACE PACKAGE BODY "PROCS_TEST_V15" AS
...
BEGIN
   ...
   OPEN out_result_set FOR SELECT 
      ...
      INVOICE.INVOICE_STATUS_ID,
      PROCS_INVOICE_V15.F_CALCULATE_INVOICE_AMOUNT(in_invoice_id) AS "INVOICE_AMOUNT",
      CHARGE.ID AS "CHARGE_ID",
      CHARGE.CHARGE_AMOUNT,
      CHARGE.TRANSACTION_ID,
      TRANSACTION.TRANSACTION_STATUS_ID
...
CREATE OR REPLACE PACKAGE BODY "PROCS_ACCOUNT_V15" AS
...
BEGIN
  ...
  PROCS_ACCOUNT_CRU_V15.CREATE_ACCOUNT_NOTE(
...
BEGIN
  ...
  out_exists := GLOBAL_CONSTANTS_V15.TRUE;
EXCEPTION
WHEN NO_DATA_FOUND THEN
  out_exists := GLOBAL_CONSTANTS_V15.FALSE;
WHEN OTHERS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
    SPROC_NAME, 'Unknown error', SQLERRM);
...
BEGIN
  ...
  IF current_account_status = GLOBAL_STATUSES_V15.ACCOUNT_DISABLED THEN
  ...
  WHERE
    SUBSCRIPTION.ACCOUNT_ID = var_account_id
    AND INVOICE.INVOICE_STATUS_ID IN ( SELECT GLOBAL_STATUSES_V15.INVOICE_OPEN FROM DUAL );
  ...
  PROCS_ACCOUNT_V15.UPDATE_ACCOUNT_STATUS(
    in_account_id        => var_account_id,
    in_account_status_id => GLOBAL_STATUSES_V15.ACCOUNT_DISABLED,
    in_updated_by        => in_updated_by
  );
  ...
  IF in_note IS NOT NULL THEN
    BEGIN
      PROCS_ACCOUNT_V15.ANNOTATE_ACCOUNT(
...
Throws exceptions:
APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
APP_EXCEPTION_CODES_V15.DUPLICATE_ERROR
*/
    in_created_by IN VARCHAR2,
    in_group_id   IN NUMBER
) AS
...
BEGIN
  ...
  PROCS_ACCOUNT_CRU_V15.CREATE_ACCOUNT(
    out_account_id        => new_account_id,
    in_account_status_id  => GLOBAL_STATUSES_V15.ACCOUNT_ACTIVE,
    in_group_id           => in_group_id,
    in_created_by         => in_created_by,
    in_system_category_id => GLOBAL_ENUMS_V15.SYSTEM_CATEGORY_LIVE
  );
...
BEGIN
  ...
  IF current_account_status != GLOBAL_STATUSES_V15.ACCOUNT_FROZEN THEN
    RAISE BAD_CURRENT_ACC_STATUS;
  END IF;
...
SPROC_NAME                 CONSTANT VARCHAR2(24) := 'GET_ACCOUNT_CREDIT_CARDS';
var_account_id             NUMBER;
var_def_instrument_type_id NUMBER;
var_def_instrument_id      NUMBER;
temp_cc_status_id          NUMBER;

-- Exceptions
WRONG_INSTR_EXCEPTION          EXCEPTION;
CAN_NOT_GET_DEF_FIN_INSTRUMENT EXCEPTION;
EXCEPTION_MESSAGE              VARCHAR2(1024);
BEGIN
  ...
  -- Check that incoming parameter is correct
  BEGIN
    SELECT
      CREDIT_CARD_STATUS.ID into temp_cc_status_id
    FROM
      CREDIT_CARD_STATUS
    WHERE
      CREDIT_CARD_STATUS.ID = in_instr_status;
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        RAISE WRONG_INSTR_EXCEPTION;
  END;

  -- Select all crdit cards for given account
  OPEN out_result_cc_set FOR
  SELECT
    CREDIT_CARD.ID,
    CREDIT_CARD.ACCOUNT_ID,
    CREDIT_CARD.INSTRUMENT_NAME,
  ...
  FROM
    CREDIT_CARD
  WHERE
    CREDIT_CARD.ACCOUNT_ID = var_account_id
    AND CREDIT_CARD.CREDIT_CARD_STATUS_ID = in_instr_status;

  -- Get default credit card if exists
  BEGIN
    PROCS_FIN_INSTRUMENTS_V15.GET_DEF_FINANCIAL_INSTRUMENT(
      in_group_id            => in_group_id,
      out_instrument_type_id => var_def_instrument_type_id,
      out_instrument_id      => var_def_instrument_id
    );
    EXCEPTION
      WHEN OTHERS THEN
        EXCEPTION_MESSAGE := SQLERRM;
        RAISE CAN_NOT_GET_DEF_FIN_INSTRUMENT;
  END;

  IF var_def_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_CREDIT_CARD THEN
    out_default_id := var_def_instrument_id;
  ELSE
    out_default_id := 0;
  END IF;
...
WHEN WRONG_INSTR_EXCEPTION THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.STATE_ERROR,
    SPROC_NAME, 'Wrong instrument status');
WHEN CAN_NOT_GET_DEF_FIN_INSTRUMENT THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.INTERNAL_ERROR,
    SPROC_NAME, 'Could not get default financial instrument', EXCEPTION_MESSAGE);
WHEN OTHERS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.UNKNOWN_ERROR,
    SPROC_NAME, 'Unknown error', SQLERRM);
...
BEGIN
  ...
  -- Check that incoming data is correct
  IF in_instr_status != GLOBAL_CONSTANTS_V15.TRUE AND in_instr_status != GLOBAL_CONSTANTS_V15.FALSE THEN
    RAISE WRONG_INSTR_EXCEPTION;
  END IF;
  ...
  WHERE
    GIFT_CERTIFICATE.PURCHASER_GROUP_ID = in_group_id
    AND (
          ( in_instr_status = GLOBAL_CONSTANTS_V15.TRUE AND
            (
              GIFT_CERTIFICATE.EXPIRATION_DATE >= current_date
              AND GIFT_CERTIFICATE.GIFT_CERTIFICATE_STATUS_ID = GLOBAL_STATUSES_V15.GIFT_CERTIFICATE_ACTIVE
            )
          )
          OR
          (
            in_instr_status = GLOBAL_CONSTANTS_V15.FALSE AND
            (
              GIFT_CERTIFICATE.EXPIRATION_DATE < current_date
              OR GIFT_CERTIFICATE.GIFT_CERTIFICATE_STATUS_ID != GLOBAL_STATUSES_V15.GIFT_CERTIFICATE_ACTIVE
            )
          )
        );
...
SPROC_NAME     CONSTANT VARCHAR2(19) := 'GET_ACCOUNT_PAYPALS';
-- VARIABLES
var_account_id NUMBER;
var_def_instrument_type_id NUMBER;
var_def_instrument_id      NUMBER;
...
BEGIN
  ...
  -- Check that all passed agruments are valid
  IF in_instr_status != GLOBAL_STATUSES_V15.PAYPAL_ACTIVE
    AND in_instr_status != GLOBAL_STATUSES_V15.PAYPAL_INACTIVE
    AND in_instr_status != GLOBAL_STATUSES_V15.PAYPAL_FROZEN THEN
    RAISE WRONG_INSTR_EXCEPTION;
  END IF;

  -- Retreiving information about paypals
  OPEN out_result_pp_set FOR
  SELECT
    PAYPAL.ID,
    PAYPAL.ACCOUNT_ID,
  ...
  FROM
    PAYPAL
  WHERE
    PAYPAL.ACCOUNT_ID = var_account_id
    AND PAYPAL.PAYPAL_STATUS_ID = in_instr_status;
  ...
  IF var_def_instrument_type_id = GLOBAL_ENUMS_V15.INSTRUMENT_PAYPAL THEN
    out_default_id := var_def_instrument_id;
  ELSE
    out_default_id := 0;
  END IF;
...
BAD_SUBSCRIPTION_STATUS EXCEPTION;
BEGIN
  -- Check that all passed data is correct
  IF in_status != GLOBAL_STATUSES_V15.SUBSCRIPTION_ACTIVE
    AND in_status != GLOBAL_STATUSES_V15.SUBSCRIPTION_SUSPENDED
    AND in_status != GLOBAL_STATUSES_V15.SUBSCRIPTION_CANCELED
    AND in_status != GLOBAL_STATUSES_V15.SUBSCRIPTION_CLOSED
  THEN
    RAISE BAD_SUBSCRIPTION_STATUS;
  END IF;
  ...
  WHERE
    SUBSCRIPTION.ACCOUNT_ID = var_account_id
    AND (SUBSCRIPTION.SCT_ID IS NULL OR SUBSCRIPTION.SCT_ID != REAL_TIME_CANCEL_REASON)
    AND SUBSCRIPTION.SUBSCRIPTION_STATUS_ID = NVL(in_status, SUBSCRIPTION.SUBSCRIPTION_STATUS_ID)
    AND PROCS_COMMON_V15.NORMALIZE_DATE(SUBSCRIPTION.PURCHASE_DATE) >= NVL(in_start_date, PROCS_COMMON_V15.NORMALIZE_DATE(SUBSCRIPTION.PURCHASE_DATE))
    AND PROCS_COMMON_V15.NORMALIZE_DATE(SUBSCRIPTION.PURCHASE_DATE) <= NVL(in_end_date, PROCS_COMMON_V15.NORMALIZE_DATE(SUBSCRIPTION.PURCHASE_DATE))
    AND (in_group_account_type IS NULL OR OFFER_CHAIN.GROUP_ACCOUNT_TYPE_ID = in_group_account_type);

EXCEPTION
WHEN BAD_SUBSCRIPTION_STATUS THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.INVALID_PARAMETER,
    SPROC_NAME, 'Bad subscription status');
WHEN BAD_GROUP_ID THEN
  PROCS_COMMON_V15.THROW_EXCEPTION(APP_EXCEPTION_CODES_V15.NOT_FOUND,
    SPROC_NAME, 'Can not find account with given group id');
WHEN OTHERS THEN
...
BEGIN
  ...
  IF var_account_status_id != GLOBAL_STATUSES_V15.ACCOUNT_ACTIVE
    AND var_account_status_id != GLOBAL_STATUSES_V15.ACCOUNT_FROZEN THEN
  ...
  PROCS_ACCOUNT_V15.UPDATE_ACCOUNT_STATUS(
    in_account_id        => var_account_id,
    in_updated_by        => in_updated_by,
    in_account_status_id => GLOBAL_STATUSES_V15.ACCOUNT_FROZEN
  );
...
BEGIN
  ...
  SELECT DISTINCT
    ...
    INVOICE.CREATE_DATE,
    INVOICE.INVOICE_STATUS_ID,
    PROCS_INVOICE_V15.F_CALCULATE_INVOICE_AMOUNT(INVOICE.ID) as "AMOUNT",
    OFFER_CHAIN.ID as "OFFER_CHAIN_ID",
    OFFER_CHAIN.NAME as "OFFER_CHAIN_NAME",
    SUBSCRIPTION.ID as "SUBSCRIPTION_ID",
    NULL as "GC_CODE",
...
BEGIN
  ...
  IF in_account_status_id != GLOBAL_STATUSES_V15.ACCOUNT_ACTIVE
    AND in_account_status_id != GLOBAL_STATUSES_V15.ACCOUNT_FROZEN
    AND in_account_status_id != GLOBAL_STATUSES_V15.ACCOUNT_DISABLED THEN
    RAISE BAD_STATUS_ID;
  END IF;
...
BEGIN
  ...
  WHERE
    SUBSCRIPTION.ACCOUNT_ID = var_account_id
    AND LICENSE.NEEDS_ENTITLEMENTS = GLOBAL_CONSTANTS_V15.TRUE;
...
BEGIN
  ...
  FROM
    ...
    INNER JOIN OFFER_CHAIN_META_DATA OCHMD ON (OCHMD.NAME = GLOBAL_CONSTANTS_V15.OCMD_UPGRADABLE_OFFER_CHAIN_ID AND TO_NUMBER(OCHMD.VALUE) = OCH.ID)
  WHERE
    S.ACCOUNT_ID = var_account_id;
...
CREATE OR REPLACE PACKAGE BODY "PUBLIC_PROCS_BILLING_V15" AS
...
BEGIN
  PROCS_OFFER_CHAIN_V15.GET_OFFER_CHAIN_BY_ID (
    in_offer_chain_id => in_offer_chain_id,
    out_result_set => out_result_set
  );
END GET_OFFER_CHAIN_BY_ID;
...
BEGIN
  PROCS_INVOICE_V15.GET_PENDING_INVOICES(
    out_result_set1,
    out_result_set2,
    out_result_set3,
    in_row_number
...
BEGIN
  PROCS_CHARGE_V15.GET_PENDING_REFUND_CHARGES(
    out_result_set,
    in_row_number
  );
END GET_PENDING_REFUND_CHARGES;
...
BEGIN
  PROCS_CHARGE_V15.GET_UNPROCESSED_CHARGES(
    in_invoice_id,
    out_result_set
  );
END GET_UNPROCESSED_CHARGES;
...
BEGIN
  PROCS_CHARGE_V15.GET_PROCESSED_CHARGES(
    in_invoice_id,
    out_result_set
  );
END GET_PROCESSED_CHARGES;
...
BEGIN
  PROCS_TRANSACTION_V15.GET_TRNSCTN_ATTEMPTS_BY_STATUS(
    in_transaction_id,
...
BEGIN
  PROCS_TRANSACTION_V15.UPDATE_TRNSCTN_ATTEMPT_STATUS(
...
BEGIN
  PROCS_TRANSACTION_V15.GET_CLOSED_REFUNDS_BY_INVOICE(
     in_invoice_id,
     out_result_set
  );
END GET_CLOSED_REFUNDS_BY_INVOICE;
...
BEGIN
  PROCS_TRANSACTION_V15.UPDATE_TRNSCTN_ATTEMPT_TIME(
    in_transaction_attempt_id,
    in_updated_by
  );
END UPDATE_TRNSCTN_ATTEMPT_TIME;
...
BEGIN
  PROCS_TRANSACTION_V15.CREATE_TRANSACTION_ATTEMPT(
    in_transaction_id,
...
BEGIN
  PROCS_TRANSACTION_V15.UPDATE_TRANSACTION_ATTEMPT_INF(
    in_transaction_attempt_id,
    in_ext_status_code,
...
BEGIN
  PROCS_TRANSACTION_V15.GET_FAILED_ATTEMPTS_NUMBER(
    in_transaction_id,
    out_attempts_num
  );
END GET_FAILED_ATTEMPTS_NUMBER;
...
BEGIN
  PROCS_TRANSACTION_V15.IS_TRANSACTION_SUCCESSFULL(
    in_transaction_id,
    out_is_successfull
  );
END IS_TRANSACTION_SUCCESSFULL;
...
BEGIN
  PROCS_SUBSCRIPTION_V15.SUSPEND_SUBSCRIPTION(
    in_subs_id,
    in_updated_by
  );
END SUSPEND_SUBSCRIPTION;
...
BEGIN
  PROCS_FIN_INSTRUMENTS_V15.GET_CREDIT_CARD_BY_ID(
    in_credit_card_id,
    out_result_set
  );
END GET_CREDIT_CARD_BY_ID;
...
BEGIN
  PROCS_TRANSACTION_V15.GET_TRANSACTION_AMOUNT(
    in_transaction_id,
...
BEGIN
  PROCS_INVOICE_V15.GET_ACCOUNT_BY_INVOICE_ID(
    in_invoice_id,
    out_account_id
  );
END GET_ACCOUNT_BY_INVOICE_ID;
...
BEGIN
  PROCS_FIN_INSTRUMENTS_V15.GET_GIFT_CERTIFICATE_BY_ID (
    in_gift_certificate_id,
    out_result_set
  );
END GET_GIFT_CERTIFICATE_BY_ID;
...
BEGIN
  PROCS_CHARGE_V15.GET_SUBSCR_ID_BY_CHARGE_ID(
    in_charge_id,
    out_subscription_id
  );
END GET_SUBSCR_ID_BY_CHARGE_ID;
...
BEGIN
  PROCS_FIN_INSTRUMENTS_V15.IS_GCERT_FOR_PROPER_OFFER (
    in_gift_certificate_id,
    in_charge_id,
    out_result
  );
...
BEGIN
  PROCS_SUBSCRIPTION_V15.GET_SUBSCRIPTION_INFO (
    in_subscription_id,
    out_result_set
  );
END GET_SUBSCRIPTION_INFO;
...
BEGIN
  PROCS_TRANSACTION_V15.GET_TRANSACTION_BY_ID(
    in_transaction_id,
    out_result_set
  );
END GET_TRANSACTION_BY_ID;
...
BEGIN
  PROCS_FIN_INSTRUMENTS_V15.GET_GC_BY_PURCH_INVOICE_ID(
    in_invoice_id,
    out_result_set 
  );
END GET_GC_BY_PURCH_INVOICE_ID;
...
BEGIN
  PROCS_TRANSACTION_V15.UPDATE_TRANSACTION_ORDER_ID(
    in_transaction_id,
    in_order_id,
    in_updated_by
  );
...
BEGIN
  PROCS_SUBSCRIPTION_V15.GET_ACTIVE_INVOICES_IDS(
    in_subscription_id, 
    out_result_set
  );
END GET_ACTIVE_INVOICES_IDS;
...
BEGIN
  PROCS_SUBSCRIPTION_V15.CANCEL_SUBSCRIPTION_INVOICE(
    in_invoice_id,
    in_updated_by,
    in_refundable
  );
...
BEGIN
  PROCS_SUBSCRIPTION_V15.FINALIZE_CANCELATION(
    in_subscription_id,
...
BEGIN
  PROCS_SUBSCRIPTION_V15.GET_SUBSCR_PROD_OFFERRINGS(
    in_subscription_id,
    out_result_set
  );
END GET_SUBSCR_PROD_OFFERRINGS;
...
BEGIN
  PROCS_OFFER_CHAIN_V15.GET_OFFER_CHAIN_META_DATA(
    in_offer_chain_id,
    in_meta_data_name,
    out_result_set
  );
...
BEGIN
  PROCS_OFFER_CHAIN_V15.GET_PRODUCT_OFFERING_META_DATA(
...
BEGIN
  PROCS_ACCOUNT_CRU_V15.READ_ACCOUNT(
    in_account_id,
    out_result_set
  );
END READ_ACCOUNT;
...
BEGIN
  PROCS_CHARGE_V15.GET_COLLECTED_CHARGES(
    in_invoice_id,
    out_result_set
  );
END GET_COLLECTED_CHARGES;
...
BEGIN
  ...
  PROCS_ACCOUNT_V15.GET_GROUPS_ID_BY_INVOICE_ID(
    in_invoice_id,
    out_group_ids
  );
...
BEGIN
  ...
  PROCS_ACCOUNT_V15.GET_ACCOUNT_ID_BY_GROUP_ID(
    in_group_id,
    out_account_id
  );
...
BEGIN
  PROCS_LOCKING_V15.LOCK_ACCOUNT(
    in_group_id,
    in_lock_key,
    in_seconds_num,
    in_created_by,
...
BEGIN
  PROCS_LOCKING_V15.RELEASE_LOCK(
    in_group_id,
    in_lock_key
  );
END RELEASE_LOCK;
...
BEGIN
  PROCS_INVOICE_V15.GET_PAYMENT_INFO_BY_INVOICE_ID(
    in_invoice_id,
    out_order_id,
    out_external_transaction_id
  );
...
BEGIN
  PROCS_FIN_INSTRUMENTS_V15.GET_PAYPAL_BY_ID(
    in_paypal_id,
    out_result_set
  );
END GET_PAYPAL_BY_ID;
...
begin
  PROCS_TRANSACTION_V15.GET_ATTEMPT_NUMBER(
    in_charge_id,
    out_attempt_count
  );
end get_attempt_number;
...
begin
  PROCS_OFFER_CHAIN_V15.GET_NOTIFICATION_TYPE_ID(
    in_offer_chain_id,
    in_action_name,
...
BEGIN
PROCS_FIN_INSTRUMENTS_V15.GET_GC_ID_BY_PURCH_INVOICE_ID(
in_invoice_id,
...
CREATE OR REPLACE PACKAGE BODY "PUBLIC_PROCS_NOTIFICATION_V15" AS
...
CREATE OR REPLACE PACKAGE BODY "PUBLIC_PROCS_RENEWAL_V15" AS

PROCEDURE SUB_EXPIRES_NEED_ENTITLEMENTS (
  out_result_set OUT SYS_REFCURSOR
) AS
BEGIN
  PROCS_GROUP_ACCOUNT_V15.SUB_EXPIRES_NEED_ENTITLEMENTS(out_result_set => out_result_set);
END SUB_EXPIRES_NEED_ENTITLEMENTS;
...
BEGIN
  PROCS_GROUP_ACCOUNT_V15.UPDATE_SS_NEED_ENTITLEMENTS(
...
BEGIN
  PROCS_LICENSE_V15.GET_ENDING_LICENSES(in_hours_number,out_result_set);
END GET_ENDING_LICENSES;
...
BEGIN
  PROCS_LICENSE_V15.GET_ENDING_LICENSES_CC(in_hours_number,out_result_set, in_process_name);
END GET_ENDING_LICENSES_CC;
...
BEGIN
  PROCS_LICENSE_V15.GET_RECURRING_OFFER (
    in_license_id,
    out_result_set
  );
END GET_RECURRING_OFFER;
...
BEGIN
  PROCS_LICENSE_V15.GET_NEXT_OFFER (
    in_license_id,
    out_result_set
  );
END GET_NEXT_OFFER;
...
BEGIN
  PROCS_LICENSE_V15.UPDATE_LICENSE_STATUS (
    in_license_id,
    in_license_status,
    in_updated_by
  );
...
BEGIN
  PROCS_SUBSCRIPTION_V15.HAS_FUTURE_LICENSE (
    in_license_id,
    out_result
  );
END HAS_FUTURE_LICENSE;
...
BEGIN
  PROCS_LICENSE_V15.GET_GROUP_ID_BY_LICENSE_ID (
    in_license_id,
    out_group_id
  );
END GET_GROUP_ID_BY_LICENSE_ID;
...
BEGIN
  PROCS_OFFER_CHAIN_V15.GET_OFFER_PRODUCTS (
    in_offer_id,
    out_result_set
  );
END GET_OFFER_PRODUCTS;
...
BEGIN
  PROCS_TRANSACTION_V15.CREATE_TRANSACTION(
    ...
    in_created_by,
    in_order_id,
    GLOBAL_CONSTANTS_V15.FALSE, -- is_refund should be false in renewal
    out_transaction_id
  );
END CREATE_TRANSACTION;
...
BEGIN
  PROCS_TRANSACTION_V15.RESERVE_TRANSACTION_ID (
    out_transaction_id
  );
END RESERVE_TRANSACTION_ID;
...
BEGIN
  PROCS_OFFER_CHAIN_V15.P_GET_NEXT_OFFER_INDEX(
    in_offer_chain_id,
    in_offer_chain_current_index,
...
BEGIN
  PROCS_OFFER_CHAIN_V15.GET_NEXT_OFFER_INDEX_BY_LCNS(
    in_license_id,
    in_offer_chain_current_index,
    out_next_offer_index
  );
...
BEGIN
  PROCS_SUBSCRIPTION_V15.CLOSE_SUBSCRIPTION(
    in_subscription_id,
    in_updated_by
  );
END CLOSE_SUBSCRIPTION;
...
BEGIN
  PROCS_LICENSE_V15.GET_NEED_ENTITLEMENTS_LICENSES(
    out_result_set
  );
END GET_NEED_ENTITLEMENTS_LICENSES;
...
BEGIN
  PROCS_LICENSE_V15.UPDATE_NEED_ENTITLEMENTS_FLAG(
    in_license_id,
    in_needs_entitlements,
    in_updated_by
  );
...
BEGIN
  PROCS_OFFER_CHAIN_V15.GET_PROD_OFFERINGS_BY_OFFER_ID(in_offer_id,out_result_set);
END GET_PROD_OFFERINGS_BY_OFFER_ID;
...
BEGIN
  PROCS_OFFER_CHAIN_V15.GET_PRODUCT_OFFERING_META_DATA(in_product_offering_id,in_meta_data_name,out_result_set);
END GET_PRODUCT_OFFERING_META_DATA;
...
BEGIN
  PROCS_INVOICE_V15.GET_INVOICE_LINE_ITEMS(
    in_invoice_id,
    out_result_set
  );
END GET_INVOICE_LINE_ITEMS;
...
BEGIN
  PROCS_PRODUCT_V15.GET_PRD_OFFERING_BY_LINE_IT_ID(
    in_line_item_id,
    out_result_set
  );
END GET_PRD_OFFERING_BY_LINE_IT_ID;
...
BEGIN
  PROCS_LINE_ITEMS_V15.GET_LINE_ITEM_DISCOUNTS(
    in_line_item_id,
    out_result_set
  );
END GET_LINE_ITEM_DISCOUNTS;
...
BEGIN
  PROCS_LINE_ITEMS_V15.UPDATE_LINE_ITEM_AMOUNT(
    in_line_item_id,
    in_amount,
    in_discount_amount,
    in_taxes_amount
...
BEGIN
  PROCS_LICENSE_V15.GET_LICENSE_BY_ID (
    in_license_id,
    out_result_set
  );
END GET_LICENSE_BY_ID;
...
BEGIN
  PROCS_OFFER_CHAIN_V15.GET_ALL_META_DATA (
    in_offer_chain_id,
    out_result_set
  );
...
BEGIN
  PROCS_SUBSCRIPTION_V15.GET_SUBSCRIPTIONS_META_DATA(
...
BEGIN
  PROCS_FIN_INSTRUMENTS_V15.GET_UNREDEEMED_GCS(
    out_result_set => out_result_set,
...
AS
BEGIN
  PROCS_SUBSCRIPTION_V15.GET_ACT_SUBS_W_CPT_CHARGEBACKS(
    out_result_set => out_result_set
  );
END GET_ACT_SUBS_W_CPT_CHARGEBACKS;
...
AS
BEGIN
  PROCS_SUBSCRIPTION_V15.GET_ACT_SUBS_W_PP_CHARGEBACKS(
    out_result_set => out_result_set
  );
END GET_ACT_SUBS_W_PP_CHARGEBACKS;
...
grant execute on CORE_OWNER.PROCS_ACCOUNT_V15 to core_app;
grant execute on CORE_OWNER.PROCS_ADX_V15 to core_app;
grant execute on CORE_OWNER.PROCS_CHARGE_V15 to core_app;
grant execute on CORE_OWNER.PROCS_COMMON_V15 to core_app;
grant execute on CORE_OWNER.PROCS_FIN_INSTRUMENTS_V15 to core_app;
grant execute on CORE_OWNER.PROCS_INVOICE_V15 to core_app;
grant execute on CORE_OWNER.PROCS_LICENSE_V15 to core_app;
grant execute on CORE_OWNER.PROCS_LINE_ITEMS_V15 to core_app;
grant execute on CORE_OWNER.PROCS_OFFER_CHAIN_V15 to core_app;
grant execute on CORE_OWNER.PROCS_PRODUCT_V15 to core_app;
grant execute on CORE_OWNER.PROCS_SUBSCRIPTION_V15 to core_app;
grant execute on CORE_OWNER.PROCS_SYSTEM_V15 to core_app;
grant execute on CORE_OWNER.PROCS_TEST_V15 to core_app;
grant execute on CORE_OWNER.PROCS_TRANSACTION_V15 to core_app;
grant execute on CORE_OWNER.PROCS_TAXES_V15 to core_app;
grant execute on CORE_OWNER.PROCS_LOCKING_V15 to core_app;
grant execute on CORE_OWNER.PROCS_ADJUSTMENTS_V15 to core_app;
grant execute on CORE_OWNER.PUBLIC_PROCS_BILLING_V15 to core_app;
grant execute on CORE_OWNER.PROCS_ADDRESS_V15 to core_app;
grant execute on CORE_OWNER.PROCS_GROUP_ACCOUNT_V15 to core_app;

grant execute on CORE_OWNER.PUBLIC_PROCS_BILLING_V15 to core_billing_app;
grant execute on CORE_OWNER.PUBLIC_PROCS_RENEWAL_V15 to core_licensing_app;
grant execute on CORE_OWNER.PROCS_GROUP_ACCOUNT_V15 to core_licensing_app;
grant execute on CORE_OWNER.PUBLIC_PROCS_NOTIFICATION_V15 to ops_notif_app;


grant execute on CORE_OWNER.PROCS_TAXES_V15 to core_tax_app;
grant execute on CORE_OWNER.PROCS_PRODUCT_V15 to core_tax_app;
grant execute on CORE_OWNER.PROCS_ACCOUNT_V15 to core_tax_app;

grant execute on CORE_OWNER.PROCS_POLLING_SYNC to core_poller_app;

grant execute on CORE_OWNER.PROCS_RECONCILIATION_CRU_V15 to etl_app;
grant execute on CORE_OWNER.PROCS_SUBSCRIPTION_V15 to etl_app;
grant execute on CORE_OWNER.PROCS_TRANSACTION_V15 to etl_app;
grant execute on CORE_OWNER.PROCS_REPORTING to etl_app;
grant execute on CORE_OWNER.PROCS_LOCKING_V15 to etl_app;
grant execute on CORE_OWNER.PROCS_ACCOUNT_V15 to etl_app;
grant execute on CORE_OWNER.PROCS_INVOICE_V15 to etl_app;

grant execute on CORE_OWNER.PROCS_ITUNES_RECEIPT_V15 to core_app;
grant execute on CORE_OWNER.PROCS_ITUNES_RECEIPT_V15 to core_subup_app;
grant execute on CORE_OWNER.PROCS_AMAZON_V15 to core_app;
grant execute on CORE_OWNER.PROCS_AMAZON_V15 to core_subup_app;
grant execute on CORE_OWNER.PROCS_LICENSE_V15 to core_subup_app;
grant execute on CORE_OWNER.PROCS_LOCKING_V15 to core_subup_app;

grant execute on CORE_OWNER.PROCS_SUBSCRIPTION_V15 to core_subup_app;
grant execute on CORE_OWNER.PROCS_GROUP_ACCOUNT_V15 to core_app;
grant execute on CORE_OWNER.PROCS_GROUP_ACCOUNT_CRU_V15 to core_app;
grant execute on CORE_OWNER.PROCS_ENTITLEMENT_V15 to core_app;

grant execute on CORE_OWNER.PROCS_CUPY to cupy_app;
grant execute on CORE_OWNER.PROCS_LOCKING_V15 to cupy_app;
